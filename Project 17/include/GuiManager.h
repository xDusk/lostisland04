...
class DragListener : public Rocket::Core::EventListener
{
  public:
    ...
    static void RegisterDraggableContainer(Rocket::Core::Element* element, Rocket::Core::ElementDocument* document);

  protected:
    virtual void ProcessEvent(Rocket::Core::Event& event);
};

class GuiListener : public Ogre::FrameListener, public OIS::MouseListener, public OIS::KeyListener
{
  private:
  ...
  public:
    GuiListener(Ogre::RenderWindow* window, Ogre::Camera* camera, Rocket::Core::Context* _context, OIS::Keyboard *keyboard, OIS::Mouse *mouse)
    {
      context = _context;
      mKeyboard = keyboard;
      mMouse = mouse;
    ...
    bool mousePressed(const OIS::MouseEvent& ROCKET_UNUSED(e), OIS::MouseButtonID id)
    {
      context->ProcessMouseButtonDown((int) id, GetKeyModifierState());
      return true;
    }

    bool mouseReleased(const OIS::MouseEvent& ROCKET_UNUSED(e), OIS::MouseButtonID id)
    {
