  ...
  */
  class ShaderParticleRenderer : public ParticleSystemRenderer, public Renderable
  {
    ...
    public:
      ...
      virtual void _updateRenderQueue(RenderQueue* queue, std::list<Particle*>& currentParticles, bool cullIndividually);
