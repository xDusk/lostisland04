...
namespace Ogre
{
  ...
  //////////////////////////////////////////////////////////////////////////
  void ShaderParticleRenderer::_updateRenderQueue(RenderQueue* queue, std::list<Particle*>& currentParticles, bool cullIndividually)
  {
    ...
    if(!currentParticles.empty())
    {
      ...
      for(std::list<Particle*>::iterator it = currentParticles.begin(); it != currentParticles.end(); ++it)
      {
