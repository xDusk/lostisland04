...
{
  //---------------------------------------------------------------------
  myTerrainMaterialGenerator::myTerrainMaterialGenerator()
  {
    // define the layers
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  myTerrainMaterialGenerator::SM2Profile::SM2Profile(TerrainMaterialGenerator* parent, const String& name, const String& desc)
  ...
  //---------------------------------------------------------------------
  myTerrainMaterialGenerator::SM2Profile::~SM2Profile()
  {
    OGRE_DELETE mShaderGen;
  }
  //---------------------------------------------------------------------
  void myTerrainMaterialGenerator::SM2Profile::requestOptions(Terrain* terrain)
  {
  ...
  //---------------------------------------------------------------------
  bool myTerrainMaterialGenerator::SM2Profile::isVertexCompressionSupported() const
  {
    return true;
  }
  //---------------------------------------------------------------------
  void myTerrainMaterialGenerator::SM2Profile::setLayerNormalMappingEnabled(bool enabled)
  {
  ...
  //---------------------------------------------------------------------
  void myTerrainMaterialGenerator::SM2Profile::setLayerParallaxMappingEnabled(bool enabled)
  {
  ...
  //---------------------------------------------------------------------
  void myTerrainMaterialGenerator::SM2Profile::setLayerSpecularMappingEnabled(bool enabled)
  {
  ...
  //---------------------------------------------------------------------
  void  myTerrainMaterialGenerator::SM2Profile::setGlobalColourMapEnabled(bool enabled)
  {
  ...
  //---------------------------------------------------------------------
  void  myTerrainMaterialGenerator::SM2Profile::setLightmapEnabled(bool enabled)
  {
  ...
  //---------------------------------------------------------------------
  void  myTerrainMaterialGenerator::SM2Profile::setCompositeMapEnabled(bool enabled)
  {
  ...
  //---------------------------------------------------------------------
  uint8 myTerrainMaterialGenerator::SM2Profile::getMaxLayers(const Terrain* terrain) const
  {
  ...
  //---------------------------------------------------------------------
  MaterialPtr myTerrainMaterialGenerator::SM2Profile::generate(const Terrain* terrain)
  {
  ...
  //---------------------------------------------------------------------
  MaterialPtr myTerrainMaterialGenerator::SM2Profile::generateForCompositeMap(const Terrain* terrain)
  {
    // re-use old material if exists
  ...
  //---------------------------------------------------------------------
  void myTerrainMaterialGenerator::SM2Profile::addTechnique(
  ...
  //---------------------------------------------------------------------
  void myTerrainMaterialGenerator::SM2Profile::updateParams(const MaterialPtr& mat, const Terrain* terrain)
  {
    mShaderGen->updateParams(this, mat, terrain, false);
  }
  //---------------------------------------------------------------------
  void myTerrainMaterialGenerator::SM2Profile::updateParamsForCompositeMap(const MaterialPtr& mat, const Terrain* terrain)
  {
  ...
  myTerrainMaterialGenerator::SM2Profile::ShaderHelper::generateVertexProgram(
    const SM2Profile* prof, const Terrain* terrain, TechniqueType tt)
  {
    ...
    LogManager::getSingleton().logMessage(ret->getSource());
#if OGRE_DEBUG_MODE
  ...
  //---------------------------------------------------------------------
  HighLevelGpuProgramPtr
  myTerrainMaterialGenerator::SM2Profile::ShaderHelper::generateFragmentProgram(
    const SM2Profile* prof, const Terrain* terrain, TechniqueType tt)
  {
  ...
  //---------------------------------------------------------------------
  void myTerrainMaterialGenerator::SM2Profile::ShaderHelper::generateVertexProgramSource(
  ...
  //---------------------------------------------------------------------
  void myTerrainMaterialGenerator::SM2Profile::ShaderHelper::generateFragmentProgramSource(
    const SM2Profile* prof, const Terrain* terrain, TechniqueType tt, StringUtil::StrStreamType& outStream)
  {
  ...
  //---------------------------------------------------------------------
  void myTerrainMaterialGenerator::SM2Profile::ShaderHelper::defaultVpParams(
  ...
  //---------------------------------------------------------------------
  void myTerrainMaterialGenerator::SM2Profile::ShaderHelper::defaultFpParams(
    const SM2Profile* prof, const Terrain* terrain, TechniqueType tt, const HighLevelGpuProgramPtr& prog)
  {
    GpuProgramParametersSharedPtr params = prog->getDefaultParameters();
    params->setIgnoreMissingParams(true);
  ...
  //---------------------------------------------------------------------
  void myTerrainMaterialGenerator::SM2Profile::ShaderHelper::updateParams(
  ...
  //---------------------------------------------------------------------
  void myTerrainMaterialGenerator::SM2Profile::ShaderHelper::updateVpParams(
  ...
  //---------------------------------------------------------------------
  void myTerrainMaterialGenerator::SM2Profile::ShaderHelper::updateFpParams(
    const SM2Profile* prof, const Terrain* terrain, TechniqueType tt, const GpuProgramParametersSharedPtr& params)
  {
    params->setIgnoreMissingParams(true);
  ...
  //---------------------------------------------------------------------
  String myTerrainMaterialGenerator::SM2Profile::ShaderHelper::getChannel(uint idx)
  {
    uint rem = idx % 4;
  ...
  //---------------------------------------------------------------------
  String myTerrainMaterialGenerator::SM2Profile::ShaderHelper::getVertexProgramName(
    const SM2Profile* prof, const Terrain* terrain, TechniqueType tt)
  {
  ...
  //---------------------------------------------------------------------
  String myTerrainMaterialGenerator::SM2Profile::ShaderHelper::getFragmentProgramName(
    const SM2Profile* prof, const Terrain* terrain, TechniqueType tt)
  {
  ...
  //---------------------------------------------------------------------
  HighLevelGpuProgramPtr
  myTerrainMaterialGenerator::SM2Profile::ShaderHelperCg::createVertexProgram(
    const SM2Profile* prof, const Terrain* terrain, TechniqueType tt)
  {
  ...
  //---------------------------------------------------------------------
  HighLevelGpuProgramPtr
  myTerrainMaterialGenerator::SM2Profile::ShaderHelperCg::createFragmentProgram(
    const SM2Profile* prof, const Terrain* terrain, TechniqueType tt)
  {
    HighLevelGpuProgramManager& mgr = HighLevelGpuProgramManager::getSingleton();
  ...
  //---------------------------------------------------------------------
  void myTerrainMaterialGenerator::SM2Profile::ShaderHelperCg::generateVpHeader(
    const SM2Profile* prof, const Terrain* terrain, TechniqueType tt, StringUtil::StrStreamType& outStream)
  {
    outStream <<
              "void main_vp(\n";
  ...
  //---------------------------------------------------------------------
  void myTerrainMaterialGenerator::SM2Profile::ShaderHelperCg::generateFpHeader(
    const SM2Profile* prof, const Terrain* terrain, TechniqueType tt, StringUtil::StrStreamType& outStream)
  {
    // Main header
    outStream <<
    ...
    if(tt != LOW_LOD)
    {
      outStream <<
                // global normal
                "	float3 normal = (( tex2D( globalNormal, uv)-0.5)*2).rgb;\n"
                "	normal = mul( WorldMatrix, float4( normal, 1)).xyz;\n";
    }
    ...
    else
    {
      ...
      if(prof->isLayerNormalMappingEnabled())
      {
        ...
        switch(terrain->getAlignment())
        {
          ...
          case Terrain::ALIGN_X_Z:
            outStream << "	float3 tangent = float3(1, 0, 0);\n"
                      "	tangent = mul( WorldMatrix, float4( tangent, 1)).xyz;\n";
            break;
          case Terrain::ALIGN_Y_Z:
        ...
        outStream << "	float3 binormal = normalize(cross( normal, tangent));\n";

        //        outStream << "  binormal = mul( WorldViewMatrix, float4( binormal, 1)).xyz;\n";
  ...
  //---------------------------------------------------------------------
  void myTerrainMaterialGenerator::SM2Profile::ShaderHelperCg::generateVpLayer(
    const SM2Profile* prof, const Terrain* terrain, TechniqueType tt, uint layer, StringUtil::StrStreamType& outStream)
  {
    // nothing to do
  }
  //---------------------------------------------------------------------
  void myTerrainMaterialGenerator::SM2Profile::ShaderHelperCg::generateFpLayer(
    const SM2Profile* prof, const Terrain* terrain, TechniqueType tt, uint layer, StringUtil::StrStreamType& outStream)
  {
    uint uvIdx = layer / 2;
    ...
    if(prof->isLayerNormalMappingEnabled())
    {
      ...
      outStream << "	float3 TSnormal" << layer
                << "  = (( tex2D( normtex" << layer << ", uv" << layer << ")-0.5)*2).rgb;\n";
      //            << "  TSnormal" << layer << "= normalize( mul( TSnormal" << layer << " , TBN));\n";
    }
    ...
    else
    {
      ...
      if(prof->isLayerNormalMappingEnabled())
        outStream << "	oTSnormal = lerp( oTSnormal, TSnormal" << layer
                  << ".rgb, " << blendWeightStr << ");\n";
    }
  }

  //---------------------------------------------------------------------
  void myTerrainMaterialGenerator::SM2Profile::ShaderHelperCg::generateVpFooter(
    const SM2Profile* prof, const Terrain* terrain, TechniqueType tt, StringUtil::StrStreamType& outStream)
  {
    outStream <<
              "	oPos = mul( viewProjMatrix, worldPos);\n"
              "	oWorldPos = mul( WorldMatrix, oPos);\n"
              "	oUVMisc.xy = uv.xy;\n}\n";
  }
  //---------------------------------------------------------------------
  void myTerrainMaterialGenerator::SM2Profile::ShaderHelperCg::generateFpFooter(
    const SM2Profile* prof, const Terrain* terrain, TechniqueType tt, StringUtil::StrStreamType& outStream)
  {
    if(terrain->getGlobalColourMapEnabled() && prof->isGlobalColourMapEnabled())
    {
    ...
    {
      // sample lightmap
      //      outStream << "float shadow = tex2D(lightMap, uv).r;\n";
      //      outStream << "  outputCol.rgb += diffuse * shadow;\n";
    }

    // Final return
    outStream << "	PS_OUTPUT Out;\n"
              "	Out.Rtt0.rgb = diffuse.rgb;\n"
              "	Out.Rtt0.a = specular;\n"
              "	Out.Rtt1.rgb = TSnormal1;\n"
              "	Out.Rtt1.a = 1;\n"
              "	Out.Rtt2 = PosInWorld;\n"
              //      " Out.Rtt2 = position;\n"
              "	Out.Rtt3 = float4( 1, 1, 1, 1);\n"
              "	return Out\n;"
              << "}\n";
  }
  ...
  //---------------------------------------------------------------------
  HighLevelGpuProgramPtr
  myTerrainMaterialGenerator::SM2Profile::ShaderHelperHLSL::createVertexProgram(
    const SM2Profile* prof, const Terrain* terrain, TechniqueType tt)
  {
    HighLevelGpuProgramManager& mgr = HighLevelGpuProgramManager::getSingleton();
    String progName = getVertexProgramName(prof, terrain, tt);
  ...
  //---------------------------------------------------------------------
  HighLevelGpuProgramPtr
  myTerrainMaterialGenerator::SM2Profile::ShaderHelperHLSL::createFragmentProgram(
    const SM2Profile* prof, const Terrain* terrain, TechniqueType tt)
  {
    HighLevelGpuProgramManager& mgr = HighLevelGpuProgramManager::getSingleton();
    String progName = getFragmentProgramName(prof, terrain, tt);
