  ...
  */
  class ImpostorPage: public GeometryPage
  {
    ...
    public:
      ...
      */
      static void setImpostorResolution(int pixels)
      {
        impostorResolution = pixels;
      }
      ...
      */
      ...
      inline void setBlendMode(ImpostorBlendMode blendMode)
      {
        this->blendMode = blendMode;
      }
      inline ImpostorBlendMode getBlendMode()
      {
        return blendMode;
      }
