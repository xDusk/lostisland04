  ...
  */
  class PagedGeometry
  {
    public:
      ...
      */
      inline const std::list<GeometryPageManager*> &getDetailLevels()
      {
        return managerList;
      }
      ...
      */
      ...
      {
        geometryAllowedVisible = visible;
      }
  ...
  class GeometryPage
  {
    ...
    public:
      ...
      */
      ...
      try to override it.
      */
      inline Ogre::Vector3 &getCenterPoint()
      {
        return _centerPoint;
      }
  ...
  class GeometryPageManager
  {
    public:
      ...
      */
      ...
      /** \brief Internal function - DO NOT USE */
      inline TPGeometryPages getLoadedPages() const
      {
        return loadedList;
      }
