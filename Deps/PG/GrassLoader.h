  ...
  */
  class GrassLoader: public PageLoader
  {
    public:
      ...
      inline std::list<GrassLayer*> &getLayerList()
      {
        return layerList;
      }
      ...
      */
      inline void setWindDirection(Ogre::Vector3 &dir)
      {
        windDir = dir;
      }

      inline void setBuildEdgesEnabled(bool value)
      {
        autoEdgeBuildEnabled = value;
      }
      inline bool getBuildEdgesEnabled()
      {
        return autoEdgeBuildEnabled;
      }
      ...
      inline Ogre::Vector3 &getWindDirection()
      {
        return windDir;
      }
      ...
      */
      inline void setDensityFactor(float density)
      {
      ...
      to take effect. */
      inline void setRenderQueueGroup(Ogre::uint8 queueID)
      {
        renderQueue = queueID;
      }
