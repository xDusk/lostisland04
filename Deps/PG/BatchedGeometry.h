...
namespace Forests
{
  ...
  class BatchedGeometry: public Ogre::MovableObject
  {
    public:
      ...
      {
        static Ogre::String t = "BatchedGeometry";
        return t;
      }
      ...
      class SubBatch: public Ogre::Renderable
      {
        public:
          ...
          {
            material = Ogre::MaterialManager::getSingleton().getByName(mat);
          }
          ...
          {
            return parent->sceneNode->_getDerivedOrientation();
          }
          const Ogre::Vector3& getWorldPosition(void) const
          {
            return parent->sceneNode->_getDerivedPosition();
          }
