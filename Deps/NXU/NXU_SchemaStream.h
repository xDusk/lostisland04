...
#define HEADER2 0x1234567
  ...
  class SchemaStream
  {
    public:
      ...
      NxuPhysicsCollection * getCurrentCollection(void) const
      {
        return mCurrentCollection;
      };
      NxSceneDesc * getCurrentScene(void) const
      {
        return mCurrentScene;
      };
      NxJointDesc * getCurrentJoint(void) const
      {
        return mCurrentJoint;
      };
      NxActorDesc * getCurrentActor(void) const
      {
        return mCurrentActor;
      };
      NxShapeDesc * getCurrentShape(void) const
      {
        return mCurrentShape;
      };
      NxFluidDesc * getCurrentFluid(void) const
      {
        return mCurrentFluid;
      };
      NxClothDesc * getCurrentCloth(void) const
      {
        return mCurrentCloth;
      };
