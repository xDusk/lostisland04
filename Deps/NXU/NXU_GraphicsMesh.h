...
#define MAXSTRLEN 256
    ...
    public:
      ...
      void ExtractOrientation(float *rot)
      {
        ...
        else
        {
          ...
          if(mElement[1][1] > mElement[0][0])
          {
            i = 1;
          }

          if(mElement[2][2] > mElement[i][i])
          {
            i = 2;
          }
      ...
      const float * GetOrientation(void) const
      {
        return mOrientation;
      };
  ...
  class NxuSkeleton
  {
    public:
      ...
      int GetNxuBoneCount(void) const
      {
        return mNxuBoneCount;
      };

      const NxuBone& GetNxuBone(int index) const
      {
        return mNxuBones[index];
      };

      NxuBone * GetNxuBonePtr(int index) const
      {
        return &mNxuBones[index];
      };

      void SetNxuBone(int index, const NxuBone &b)
      {
        mNxuBones[index] = b;
      };
