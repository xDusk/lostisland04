  ...
  class ParsePxl
  {
    public:
      ...
      NodeType getElementType(const char *str)
      {
        ...
        if(strcasecmp(str, "SceneGraph") == 0)
        {
          ret = NT_SCENE_GRAPH;
        }
        else if(strcasecmp(str, "Mesh") == 0)
        {
          ret = NT_MESH;
        }
        else if(strcasecmp(str, "Animation") == 0)
        {
          ret = NT_ANIMATION;
        }
        else if(strcasecmp(str, "Skeleton") == 0)
        {
          ret = NT_SKELETON;
        }
        else if(strcasecmp(str, "Bone") == 0)
        {
          ret = NT_BONE;
        }
        else if(strcasecmp(str, "MeshSection") == 0)
        {
          ret = NT_MESH_SECTION;
        }
        else if(strcasecmp(str, "VertexBuffer") == 0)
        {
          ret = NT_VERTEX_BUFFER;
        }
        else if(strcasecmp(str, "TetraMesh") == 0)
        {
          ret = NT_NODE_TETRA_MESH;
        }
        else if(strcasecmp(str, "IndexBuffer") == 0)
        {
          ret = NT_INDEX_BUFFER;
        }
        else if(strcasecmp(str, "NodeTriangle") == 0)
        {
          ret = NT_NODE_TRIANGLE;
        }
        else if(strcasecmp(str, "NodeInstance") == 0)
        {
          ret = NT_NODE_INSTANCE;
        }
        else if(strcasecmp(str, "AnimTrack") == 0)
        {
          ret = NT_ANIM_TRACK;
        }
      ...
      AttributeType getAttributeType(const char *str)
      {
        ...
        else if(strcasecmp(str, "parent") == 0)
        {
          ret = AT_PARENT;
        }
        else if(strcasecmp(str, "material") == 0)
        {
          ret = AT_MATERIAL;
        }
        else if(strcasecmp(str, "ctype") == 0)
        {
          ret = AT_CTYPE;
        }
        else if(strcasecmp(str, "semantic") == 0)
        {
          ret = AT_SEMANTIC;
        }
        ...
        else if(strcasecmp(str, "orientation") == 0)
        {
          ret = AT_ORIENTATION;
        }
        ...
        else if(strcasecmp(str, "dtime") == 0)
        {
          ret = AT_DTIME;
        }
        else if(strcasecmp(str, "trackcount") == 0)
        {
          ret = AT_TRACK_COUNT;
        }
        else if(strcasecmp(str, "framecount") == 0)
        {
          ret = AT_FRAME_COUNT;
        }
