...
namespace NXU
{
  ...
  const char * EnumToString(NxParameter v)
  {
    ...
    switch(v)
    {
      ...
      case NX_VISUALIZE_BODY_JOINT_GROUPS:
        ret = "NX_VISUALIZE_BODY_JOINT_GROUPS";
        break;
#if NX_SDK_VERSION_NUMBER < 270 && NX_SDK_VERSION_NUMBER != 263
      case NX_VISUALIZE_BODY_CONTACT_LIST:
        ret = "NX_VISUALIZE_BODY_CONTACT_LIST";
        break;
#endif
#if NX_SDK_VERSION_NUMBER < 270 && NX_SDK_VERSION_NUMBER != 263
      case NX_VISUALIZE_BODY_JOINT_LIST:
        ret = "NX_VISUALIZE_BODY_JOINT_LIST";
        break;
#endif
#if NX_SDK_VERSION_NUMBER < 270 && NX_SDK_VERSION_NUMBER != 263
      case NX_VISUALIZE_BODY_DAMPING:
        ret = "NX_VISUALIZE_BODY_DAMPING";
        break;
#endif
#if NX_SDK_VERSION_NUMBER < 270 && NX_SDK_VERSION_NUMBER != 263
      ...
      case NX_VISUALIZE_JOINT_LOCAL_AXES:
        ret = "NX_VISUALIZE_JOINT_LOCAL_AXES";
        break;
      case NX_VISUALIZE_JOINT_WORLD_AXES:
        ret = "NX_VISUALIZE_JOINT_WORLD_AXES";
        break;
      case NX_VISUALIZE_JOINT_LIMITS:
        ret = "NX_VISUALIZE_JOINT_LIMITS";
        break;
#if NX_SDK_VERSION_NUMBER < 270 && NX_SDK_VERSION_NUMBER != 263
      case NX_VISUALIZE_JOINT_ERROR:
        ret = "NX_VISUALIZE_JOINT_ERROR";
        break;
#endif
#if NX_SDK_VERSION_NUMBER < 270 && NX_SDK_VERSION_NUMBER != 263
      case NX_VISUALIZE_JOINT_FORCE:
        ret = "NX_VISUALIZE_JOINT_FORCE";
        break;
#endif
#if NX_SDK_VERSION_NUMBER < 270 && NX_SDK_VERSION_NUMBER != 263
      case NX_VISUALIZE_JOINT_REDUCED:
        ret = "NX_VISUALIZE_JOINT_REDUCED";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >=270
      case NX_DUMMY30:
      ...
      case NX_VISUALIZE_CONTACT_POINT:
        ret = "NX_VISUALIZE_CONTACT_POINT";
        break;
      case NX_VISUALIZE_CONTACT_NORMAL:
        ret = "NX_VISUALIZE_CONTACT_NORMAL";
        break;
      case NX_VISUALIZE_CONTACT_ERROR:
        ret = "NX_VISUALIZE_CONTACT_ERROR";
        break;
      case NX_VISUALIZE_CONTACT_FORCE:
        ret = "NX_VISUALIZE_CONTACT_FORCE";
        break;
      case NX_VISUALIZE_ACTOR_AXES:
        ret = "NX_VISUALIZE_ACTOR_AXES";
        break;
      case NX_VISUALIZE_COLLISION_AABBS:
        ret = "NX_VISUALIZE_COLLISION_AABBS";
        break;
      case NX_VISUALIZE_COLLISION_SHAPES:
        ret = "NX_VISUALIZE_COLLISION_SHAPES";
        break;
      case NX_VISUALIZE_COLLISION_AXES:
        ret = "NX_VISUALIZE_COLLISION_AXES";
        break;
      case NX_VISUALIZE_COLLISION_COMPOUNDS:
        ret = "NX_VISUALIZE_COLLISION_COMPOUNDS";
        break;
      case NX_VISUALIZE_COLLISION_VNORMALS:
        ret = "NX_VISUALIZE_COLLISION_VNORMALS";
        break;
      case NX_VISUALIZE_COLLISION_FNORMALS:
        ret = "NX_VISUALIZE_COLLISION_FNORMALS";
        break;
      case NX_VISUALIZE_COLLISION_EDGES:
        ret = "NX_VISUALIZE_COLLISION_EDGES";
        break;
      case NX_VISUALIZE_COLLISION_SPHERES:
        ret = "NX_VISUALIZE_COLLISION_SPHERES";
        break;
#if NX_SDK_VERSION_NUMBER < 280
      case NX_VISUALIZE_COLLISION_SAP:
        ret = "NX_VISUALIZE_COLLISION_SAP";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >=280
      case NX_DUMMY46:
      ...
      case NX_VISUALIZE_COLLISION_STATIC:
        ret = "NX_VISUALIZE_COLLISION_STATIC";
        break;
      case NX_VISUALIZE_COLLISION_DYNAMIC:
        ret = "NX_VISUALIZE_COLLISION_DYNAMIC";
        break;
      case NX_VISUALIZE_COLLISION_FREE:
        ret = "NX_VISUALIZE_COLLISION_FREE";
        break;
      case NX_VISUALIZE_COLLISION_CCD:
        ret = "NX_VISUALIZE_COLLISION_CCD";
        break;
      case NX_VISUALIZE_COLLISION_SKELETONS:
        ret = "NX_VISUALIZE_COLLISION_SKELETONS";
        break;
      case NX_VISUALIZE_FLUID_EMITTERS:
        ret = "NX_VISUALIZE_FLUID_EMITTERS";
        break;
      case NX_VISUALIZE_FLUID_POSITION:
        ret = "NX_VISUALIZE_FLUID_POSITION";
        break;
      case NX_VISUALIZE_FLUID_VELOCITY:
        ret = "NX_VISUALIZE_FLUID_VELOCITY";
        break;
      case NX_VISUALIZE_FLUID_KERNEL_RADIUS:
        ret = "NX_VISUALIZE_FLUID_KERNEL_RADIUS";
        break;
      case NX_VISUALIZE_FLUID_BOUNDS:
        ret = "NX_VISUALIZE_FLUID_BOUNDS";
        break;
      case NX_VISUALIZE_FLUID_PACKETS:
        ret = "NX_VISUALIZE_FLUID_PACKETS";
        break;
      case NX_VISUALIZE_FLUID_MOTION_LIMIT:
        ret = "NX_VISUALIZE_FLUID_MOTION_LIMIT";
        break;
      case NX_VISUALIZE_FLUID_DYN_COLLISION:
        ret = "NX_VISUALIZE_FLUID_DYN_COLLISION";
        break;
#if NX_SDK_VERSION_NUMBER >= 260
      case NX_VISUALIZE_FLUID_STC_COLLISION:
        ret = "NX_VISUALIZE_FLUID_STC_COLLISION";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 260
      ...
      case NX_VISUALIZE_FLUID_DRAINS:
        ret = "NX_VISUALIZE_FLUID_DRAINS";
        break;
#if NX_SDK_VERSION_NUMBER >= 260
      case NX_VISUALIZE_CLOTH_MESH:
        ret = "NX_VISUALIZE_CLOTH_MESH";
        break;
#endif
      case NX_VISUALIZE_CLOTH_COLLISIONS:
        ret = "NX_VISUALIZE_CLOTH_COLLISIONS";
        break;
      case NX_VISUALIZE_CLOTH_SELFCOLLISIONS:
        ret = "NX_VISUALIZE_CLOTH_SELFCOLLISIONS";
        break;
      ...
      case NX_ADAPTIVE_FORCE:
        ret = "NX_ADAPTIVE_FORCE";
        break;
      case NX_COLL_VETO_JOINTED:
        ret = "NX_COLL_VETO_JOINTED";
        break;
      case NX_TRIGGER_TRIGGER_CALLBACK:
        ret = "NX_TRIGGER_TRIGGER_CALLBACK";
        break;
      case NX_SELECT_HW_ALGO:
        ret = "NX_SELECT_HW_ALGO";
        break;
      case NX_VISUALIZE_ACTIVE_VERTICES:
        ret = "NX_VISUALIZE_ACTIVE_VERTICES";
        break;
      case NX_CCD_EPSILON:
        ret = "NX_CCD_EPSILON";
        break;
      case NX_SOLVER_CONVERGENCE_THRESHOLD:
        ret = "NX_SOLVER_CONVERGENCE_THRESHOLD";
        break;
      case NX_BBOX_NOISE_LEVEL:
        ret = "NX_BBOX_NOISE_LEVEL";
        break;
#if NX_SDK_VERSION_NUMBER >= 250
      case NX_IMPLICIT_SWEEP_CACHE_SIZE:
        ret = "NX_IMPLICIT_SWEEP_CACHE_SIZE";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 260
      case NX_DEFAULT_SLEEP_ENERGY:
        ret = "NX_DEFAULT_SLEEP_ENERGY";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 270
      case NX_CONSTANT_FLUID_MAX_PACKETS:
        ret = "NX_CONSTANT_FLUID_MAX_PACKETS";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 270
      case NX_CONSTANT_FLUID_MAX_PARTICLES_PER_STEP:
        ret = "NX_CONSTANT_FLUID_MAX_PARTICLES_PER_STEP";
        break;
#endif
#if NX_SDK_VERSION_NUMBER == 250 || NX_SDK_VERSION_NUMBER == 251
      case NX_GRID_HASH_CELL_SIZE:
        ret = "NX_GRID_HASH_CELL_SIZE";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 270
      case NX_VISUALIZE_CLOTH_TEARABLE_VERTICES:
        ret = "NX_VISUALIZE_CLOTH_TEARABLE_VERTICES";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 270
      case NX_VISUALIZE_CLOTH_TEARING:
        ret = "NX_VISUALIZE_CLOTH_TEARING";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 270
      case NX_VISUALIZE_CLOTH_ATTACHMENT:
        ret = "NX_VISUALIZE_CLOTH_ATTACHMENT";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 270
      case NX_VISUALIZE_SOFTBODY_MESH:
        ret = "NX_VISUALIZE_SOFTBODY_MESH";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 270
      case NX_VISUALIZE_SOFTBODY_COLLISIONS:
        ret = "NX_VISUALIZE_SOFTBODY_COLLISIONS";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 270
      case NX_VISUALIZE_SOFTBODY_WORKPACKETS:
        ret = "NX_VISUALIZE_SOFTBODY_WORKPACKETS";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 270
      case NX_VISUALIZE_SOFTBODY_SLEEP:
        ret = "NX_VISUALIZE_SOFTBODY_SLEEP";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 270
      case NX_VISUALIZE_SOFTBODY_TEARABLE_VERTICES:
        ret = "NX_VISUALIZE_SOFTBODY_TEARABLE_VERTICES";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 270
      case NX_VISUALIZE_SOFTBODY_TEARING:
        ret = "NX_VISUALIZE_SOFTBODY_TEARING";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 270
      case NX_VISUALIZE_SOFTBODY_ATTACHMENT:
        ret = "NX_VISUALIZE_SOFTBODY_ATTACHMENT";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 270
      case NX_VISUALIZE_FLUID_PACKET_DATA:
        ret = "NX_VISUALIZE_FLUID_PACKET_DATA";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 272
      case NX_VISUALIZE_FORCE_FIELDS:
        ret = "NX_VISUALIZE_FORCE_FIELDS";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 272
      case NX_VISUALIZE_CLOTH_VALIDBOUNDS:
        ret = "NX_VISUALIZE_CLOTH_VALIDBOUNDS";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 272
      case NX_VISUALIZE_SOFTBODY_VALIDBOUNDS:
        ret = "NX_VISUALIZE_SOFTBODY_VALIDBOUNDS";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 272
      case NX_VISUALIZE_CLOTH_SLEEP_VERTEX:
        ret = "NX_VISUALIZE_CLOTH_SLEEP_VERTEX";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 272
      case NX_VISUALIZE_SOFTBODY_SLEEP_VERTEX:
        ret = "NX_VISUALIZE_SOFTBODY_SLEEP_VERTEX";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 272
      case NX_ASYNCHRONOUS_MESH_CREATION:
        ret = "NX_ASYNCHRONOUS_MESH_CREATION";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 280
      case NX_FORCE_FIELD_CUSTOM_KERNEL_EPSILON:
        ret = "NX_FORCE_FIELD_CUSTOM_KERNEL_EPSILON";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 281
      case NX_IMPROVED_SPRING_SOLVER:
        ret = "NX_IMPROVED_SPRING_SOLVER";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 281
      case NX_FAST_MASSIVE_BP_VOLUME_DELETION:
        ret = "NX_FAST_MASSIVE_BP_VOLUME_DELETION";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 281
      case NX_LEGACY_JOINT_DRIVE:
        ret = "NX_LEGACY_JOINT_DRIVE";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 283
      case NX_VISUALIZE_CLOTH_HIERARCHY:
        ret = "NX_VISUALIZE_CLOTH_HIERARCHY";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 283
      case NX_VISUALIZE_CLOTH_HARD_STRETCHING_LIMITATION:
        ret = "NX_VISUALIZE_CLOTH_HARD_STRETCHING_LIMITATION";
        break;
#endif
      case NX_PARAMS_NUM_VALUES:
        ret = "NX_PARAMS_NUM_VALUES";
        break;
      default:
        break;
    }
  ...
  bool         StringToEnum(const char *str, NxParameter &v)
  {
    ...
    if(str)
    {
      ...
      else if(strcasecmp(str, "NX_PENALTY_FORCE") == 0)
      {
        v = NX_PENALTY_FORCE;
        ret = true;
      }
      else if(strcasecmp(str, "NX_SKIN_WIDTH") == 0)
      {
        v = NX_SKIN_WIDTH;
        ret = true;
      }
      else if(strcasecmp(str, "NX_DEFAULT_SLEEP_LIN_VEL_SQUARED") == 0)
      {
        v = NX_DEFAULT_SLEEP_LIN_VEL_SQUARED;
        ret = true;
      }
      else if(strcasecmp(str, "NX_DEFAULT_SLEEP_ANG_VEL_SQUARED") == 0)
      {
        v = NX_DEFAULT_SLEEP_ANG_VEL_SQUARED;
        ret = true;
      }
      else if(strcasecmp(str, "NX_BOUNCE_THRESHOLD") == 0)
      {
        v = NX_BOUNCE_THRESHOLD;
        ret = true;
      }
      else if(strcasecmp(str, "NX_DYN_FRICT_SCALING") == 0)
      {
        v = NX_DYN_FRICT_SCALING;
        ret = true;
      }
      else if(strcasecmp(str, "NX_STA_FRICT_SCALING") == 0)
      {
        v = NX_STA_FRICT_SCALING;
        ret = true;
      }
      else if(strcasecmp(str, "NX_MAX_ANGULAR_VELOCITY") == 0)
      {
        v = NX_MAX_ANGULAR_VELOCITY;
        ret = true;
      }
      else if(strcasecmp(str, "NX_CONTINUOUS_CD") == 0)
      {
        v = NX_CONTINUOUS_CD;
        ret = true;
      }
      else if(strcasecmp(str, "NX_VISUALIZATION_SCALE") == 0)
      {
        v = NX_VISUALIZATION_SCALE;
        ret = true;
      }
      else if(strcasecmp(str, "NX_VISUALIZE_WORLD_AXES") == 0)
      {
        v = NX_VISUALIZE_WORLD_AXES;
        ret = true;
      }
      else if(strcasecmp(str, "NX_VISUALIZE_BODY_AXES") == 0)
      {
        v = NX_VISUALIZE_BODY_AXES;
        ret = true;
      }
      else if(strcasecmp(str, "NX_VISUALIZE_BODY_MASS_AXES") == 0)
      {
        v = NX_VISUALIZE_BODY_MASS_AXES;
        ret = true;
      }
      else if(strcasecmp(str, "NX_VISUALIZE_BODY_LIN_VELOCITY") == 0)
      {
        v = NX_VISUALIZE_BODY_LIN_VELOCITY;
        ret = true;
      }
      else if(strcasecmp(str, "NX_VISUALIZE_BODY_ANG_VELOCITY") == 0)
      {
        v = NX_VISUALIZE_BODY_ANG_VELOCITY;
        ret = true;
      }

#if NX_SDK_VERSION_NUMBER < 270 && NX_SDK_VERSION_NUMBER != 263
      else if(strcasecmp(str, "NX_VISUALIZE_BODY_LIN_MOMENTUM") == 0)
      {
        v = NX_VISUALIZE_BODY_LIN_MOMENTUM;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER < 270 && NX_SDK_VERSION_NUMBER != 263
      else if(strcasecmp(str, "NX_VISUALIZE_BODY_ANG_MOMENTUM") == 0)
      {
        v = NX_VISUALIZE_BODY_ANG_MOMENTUM;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER < 270 && NX_SDK_VERSION_NUMBER != 263
      else if(strcasecmp(str, "NX_VISUALIZE_BODY_LIN_ACCEL") == 0)
      {
        v = NX_VISUALIZE_BODY_LIN_ACCEL;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER < 270 && NX_SDK_VERSION_NUMBER != 263
      else if(strcasecmp(str, "NX_VISUALIZE_BODY_ANG_ACCEL") == 0)
      {
        v = NX_VISUALIZE_BODY_ANG_ACCEL;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER < 270 && NX_SDK_VERSION_NUMBER != 263
      else if(strcasecmp(str, "NX_VISUALIZE_BODY_LIN_FORCE") == 0)
      {
        v = NX_VISUALIZE_BODY_LIN_FORCE;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER < 270 && NX_SDK_VERSION_NUMBER != 263
      else if(strcasecmp(str, "NX_VISUALIZE_BODY_ANG_FORCE") == 0)
      {
        v = NX_VISUALIZE_BODY_ANG_FORCE;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER < 270 && NX_SDK_VERSION_NUMBER != 263
      else if(strcasecmp(str, "NX_VISUALIZE_BODY_REDUCED") == 0)
      {
        v = NX_VISUALIZE_BODY_REDUCED;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER >=270
      else if(strcasecmp(str, "NX_DUMMY15") == 0)
      {
        v = NX_DUMMY15;
        ret = true;
      }
...
#endif
#if NX_SDK_VERSION_NUMBER >=270
      else if(strcasecmp(str, "NX_DUMMY16") == 0)
      {
        v = NX_DUMMY16;
        ret = true;
      }
...
#endif
#if NX_SDK_VERSION_NUMBER >=270
      else if(strcasecmp(str, "NX_DUMMY17") == 0)
      {
        v = NX_DUMMY17;
        ret = true;
      }
...
#endif
#if NX_SDK_VERSION_NUMBER >=270
      else if(strcasecmp(str, "NX_DUMMY18") == 0)
      {
        v = NX_DUMMY18;
        ret = true;
      }
...
#endif
#if NX_SDK_VERSION_NUMBER >=270
      else if(strcasecmp(str, "NX_DUMMY19") == 0)
      {
        v = NX_DUMMY19;
        ret = true;
      }
...
#endif
#if NX_SDK_VERSION_NUMBER >=270
      else if(strcasecmp(str, "NX_DUMMY20") == 0)
      {
        v = NX_DUMMY20;
        ret = true;
      }
...
#endif
#if NX_SDK_VERSION_NUMBER >=270
      else if(strcasecmp(str, "NX_DUMMY21") == 0)
      {
        v = NX_DUMMY21;
        ret = true;
      }
...
#endif
      else if(strcasecmp(str, "NX_VISUALIZE_BODY_JOINT_GROUPS") == 0)
      {
        v = NX_VISUALIZE_BODY_JOINT_GROUPS;
        ret = true;
      }

#if NX_SDK_VERSION_NUMBER < 270 && NX_SDK_VERSION_NUMBER != 263
      else if(strcasecmp(str, "NX_VISUALIZE_BODY_CONTACT_LIST") == 0)
      {
        v = NX_VISUALIZE_BODY_CONTACT_LIST;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER < 270 && NX_SDK_VERSION_NUMBER != 263
      else if(strcasecmp(str, "NX_VISUALIZE_BODY_JOINT_LIST") == 0)
      {
        v = NX_VISUALIZE_BODY_JOINT_LIST;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER < 270 && NX_SDK_VERSION_NUMBER != 263
      else if(strcasecmp(str, "NX_VISUALIZE_BODY_DAMPING") == 0)
      {
        v = NX_VISUALIZE_BODY_DAMPING;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER < 270 && NX_SDK_VERSION_NUMBER != 263
      else if(strcasecmp(str, "NX_VISUALIZE_BODY_SLEEP") == 0)
      {
        v = NX_VISUALIZE_BODY_SLEEP;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER >=270
      else if(strcasecmp(str, "NX_DUMMY23") == 0)
      {
        v = NX_DUMMY23;
        ret = true;
      }
...
#endif
#if NX_SDK_VERSION_NUMBER >=270
      else if(strcasecmp(str, "NX_DUMMY24") == 0)
      {
        v = NX_DUMMY24;
        ret = true;
      }
...
#endif
#if NX_SDK_VERSION_NUMBER >=270
      else if(strcasecmp(str, "NX_DUMMY25") == 0)
      {
        v = NX_DUMMY25;
        ret = true;
      }
...
#endif
#if NX_SDK_VERSION_NUMBER >=270
      else if(strcasecmp(str, "NX_DUMMY26") == 0)
      {
        v = NX_DUMMY26;
        ret = true;
      }
...
#endif
      else if(strcasecmp(str, "NX_VISUALIZE_JOINT_LOCAL_AXES") == 0)
      {
        v = NX_VISUALIZE_JOINT_LOCAL_AXES;
        ret = true;
      }
      else if(strcasecmp(str, "NX_VISUALIZE_JOINT_WORLD_AXES") == 0)
      {
        v = NX_VISUALIZE_JOINT_WORLD_AXES;
        ret = true;
      }
      else if(strcasecmp(str, "NX_VISUALIZE_JOINT_LIMITS") == 0)
      {
        v = NX_VISUALIZE_JOINT_LIMITS;
        ret = true;
      }

#if NX_SDK_VERSION_NUMBER < 270 && NX_SDK_VERSION_NUMBER != 263
      else if(strcasecmp(str, "NX_VISUALIZE_JOINT_ERROR") == 0)
      {
        v = NX_VISUALIZE_JOINT_ERROR;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER < 270 && NX_SDK_VERSION_NUMBER != 263
      else if(strcasecmp(str, "NX_VISUALIZE_JOINT_FORCE") == 0)
      {
        v = NX_VISUALIZE_JOINT_FORCE;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER < 270 && NX_SDK_VERSION_NUMBER != 263
      else if(strcasecmp(str, "NX_VISUALIZE_JOINT_REDUCED") == 0)
      {
        v = NX_VISUALIZE_JOINT_REDUCED;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER >=270
      else if(strcasecmp(str, "NX_DUMMY30") == 0)
      {
        v = NX_DUMMY30;
        ret = true;
      }
...
#endif
#if NX_SDK_VERSION_NUMBER >=270
      else if(strcasecmp(str, "NX_DUMMY31") == 0)
      {
        v = NX_DUMMY31;
        ret = true;
      }
...
#endif
#if NX_SDK_VERSION_NUMBER >=270
      else if(strcasecmp(str, "NX_DUMMY32") == 0)
      {
        v = NX_DUMMY32;
        ret = true;
      }
...
#endif
      else if(strcasecmp(str, "NX_VISUALIZE_CONTACT_POINT") == 0)
      {
        v = NX_VISUALIZE_CONTACT_POINT;
        ret = true;
      }
      else if(strcasecmp(str, "NX_VISUALIZE_CONTACT_NORMAL") == 0)
      {
        v = NX_VISUALIZE_CONTACT_NORMAL;
        ret = true;
      }
      else if(strcasecmp(str, "NX_VISUALIZE_CONTACT_ERROR") == 0)
      {
        v = NX_VISUALIZE_CONTACT_ERROR;
        ret = true;
      }
      else if(strcasecmp(str, "NX_VISUALIZE_CONTACT_FORCE") == 0)
      {
        v = NX_VISUALIZE_CONTACT_FORCE;
        ret = true;
      }
      else if(strcasecmp(str, "NX_VISUALIZE_ACTOR_AXES") == 0)
      {
        v = NX_VISUALIZE_ACTOR_AXES;
        ret = true;
      }
      else if(strcasecmp(str, "NX_VISUALIZE_COLLISION_AABBS") == 0)
      {
        v = NX_VISUALIZE_COLLISION_AABBS;
        ret = true;
      }
      else if(strcasecmp(str, "NX_VISUALIZE_COLLISION_SHAPES") == 0)
      {
        v = NX_VISUALIZE_COLLISION_SHAPES;
        ret = true;
      }
      else if(strcasecmp(str, "NX_VISUALIZE_COLLISION_AXES") == 0)
      {
        v = NX_VISUALIZE_COLLISION_AXES;
        ret = true;
      }
      else if(strcasecmp(str, "NX_VISUALIZE_COLLISION_COMPOUNDS") == 0)
      {
        v = NX_VISUALIZE_COLLISION_COMPOUNDS;
        ret = true;
      }
      else if(strcasecmp(str, "NX_VISUALIZE_COLLISION_VNORMALS") == 0)
      {
        v = NX_VISUALIZE_COLLISION_VNORMALS;
        ret = true;
      }
      else if(strcasecmp(str, "NX_VISUALIZE_COLLISION_FNORMALS") == 0)
      {
        v = NX_VISUALIZE_COLLISION_FNORMALS;
        ret = true;
      }
      else if(strcasecmp(str, "NX_VISUALIZE_COLLISION_EDGES") == 0)
      {
        v = NX_VISUALIZE_COLLISION_EDGES;
        ret = true;
      }
      else if(strcasecmp(str, "NX_VISUALIZE_COLLISION_SPHERES") == 0)
      {
        v = NX_VISUALIZE_COLLISION_SPHERES;
        ret = true;
      }

#if NX_SDK_VERSION_NUMBER < 280
      else if(strcasecmp(str, "NX_VISUALIZE_COLLISION_SAP") == 0)
      {
        v = NX_VISUALIZE_COLLISION_SAP;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER >=280
      else if(strcasecmp(str, "NX_DUMMY46") == 0)
      {
        v = NX_DUMMY46;
        ret = true;
      }
...
#endif
      else if(strcasecmp(str, "NX_VISUALIZE_COLLISION_STATIC") == 0)
      {
        v = NX_VISUALIZE_COLLISION_STATIC;
        ret = true;
      }
      else if(strcasecmp(str, "NX_VISUALIZE_COLLISION_DYNAMIC") == 0)
      {
        v = NX_VISUALIZE_COLLISION_DYNAMIC;
        ret = true;
      }
      else if(strcasecmp(str, "NX_VISUALIZE_COLLISION_FREE") == 0)
      {
        v = NX_VISUALIZE_COLLISION_FREE;
        ret = true;
      }
      else if(strcasecmp(str, "NX_VISUALIZE_COLLISION_CCD") == 0)
      {
        v = NX_VISUALIZE_COLLISION_CCD;
        ret = true;
      }
      else if(strcasecmp(str, "NX_VISUALIZE_COLLISION_SKELETONS") == 0)
      {
        v = NX_VISUALIZE_COLLISION_SKELETONS;
        ret = true;
      }
      else if(strcasecmp(str, "NX_VISUALIZE_FLUID_EMITTERS") == 0)
      {
        v = NX_VISUALIZE_FLUID_EMITTERS;
        ret = true;
      }
      else if(strcasecmp(str, "NX_VISUALIZE_FLUID_POSITION") == 0)
      {
        v = NX_VISUALIZE_FLUID_POSITION;
        ret = true;
      }
      else if(strcasecmp(str, "NX_VISUALIZE_FLUID_VELOCITY") == 0)
      {
        v = NX_VISUALIZE_FLUID_VELOCITY;
        ret = true;
      }
      else if(strcasecmp(str, "NX_VISUALIZE_FLUID_KERNEL_RADIUS") == 0)
      {
        v = NX_VISUALIZE_FLUID_KERNEL_RADIUS;
        ret = true;
      }
      else if(strcasecmp(str, "NX_VISUALIZE_FLUID_BOUNDS") == 0)
      {
        v = NX_VISUALIZE_FLUID_BOUNDS;
        ret = true;
      }
      else if(strcasecmp(str, "NX_VISUALIZE_FLUID_PACKETS") == 0)
      {
        v = NX_VISUALIZE_FLUID_PACKETS;
        ret = true;
      }
      else if(strcasecmp(str, "NX_VISUALIZE_FLUID_MOTION_LIMIT") == 0)
      {
        v = NX_VISUALIZE_FLUID_MOTION_LIMIT;
        ret = true;
      }
      else if(strcasecmp(str, "NX_VISUALIZE_FLUID_DYN_COLLISION") == 0)
      {
        v = NX_VISUALIZE_FLUID_DYN_COLLISION;
        ret = true;
      }

#if NX_SDK_VERSION_NUMBER >= 260
      else if(strcasecmp(str, "NX_VISUALIZE_FLUID_STC_COLLISION") == 0)
      {
        v = NX_VISUALIZE_FLUID_STC_COLLISION;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER >= 260
      else if(strcasecmp(str, "NX_VISUALIZE_FLUID_MESH_PACKETS") == 0)
      {
        v = NX_VISUALIZE_FLUID_MESH_PACKETS;
        ret = true;
      }

#endif
      else if(strcasecmp(str, "NX_VISUALIZE_FLUID_DRAINS") == 0)
      {
        v = NX_VISUALIZE_FLUID_DRAINS;
        ret = true;
      }

#if NX_SDK_VERSION_NUMBER >= 260
      else if(strcasecmp(str, "NX_VISUALIZE_CLOTH_MESH") == 0)
      {
        v = NX_VISUALIZE_CLOTH_MESH;
        ret = true;
      }

#endif
      else if(strcasecmp(str, "NX_VISUALIZE_CLOTH_COLLISIONS") == 0)
      {
        v = NX_VISUALIZE_CLOTH_COLLISIONS;
        ret = true;
      }
      else if(strcasecmp(str, "NX_VISUALIZE_CLOTH_SELFCOLLISIONS") == 0)
      {
        v = NX_VISUALIZE_CLOTH_SELFCOLLISIONS;
        ret = true;
      }
      else if(strcasecmp(str, "NX_VISUALIZE_CLOTH_WORKPACKETS") == 0)
      {
        v = NX_VISUALIZE_CLOTH_WORKPACKETS;
        ret = true;
      }

#if NX_SDK_VERSION_NUMBER >= 250
      else if(strcasecmp(str, "NX_VISUALIZE_CLOTH_SLEEP") == 0)
      {
        v = NX_VISUALIZE_CLOTH_SLEEP;
        ret = true;
      }

#endif
      else if(strcasecmp(str, "NX_ADAPTIVE_FORCE") == 0)
      {
        v = NX_ADAPTIVE_FORCE;
        ret = true;
      }
      else if(strcasecmp(str, "NX_COLL_VETO_JOINTED") == 0)
      {
        v = NX_COLL_VETO_JOINTED;
        ret = true;
      }
      else if(strcasecmp(str, "NX_TRIGGER_TRIGGER_CALLBACK") == 0)
      {
        v = NX_TRIGGER_TRIGGER_CALLBACK;
        ret = true;
      }
      else if(strcasecmp(str, "NX_SELECT_HW_ALGO") == 0)
      {
        v = NX_SELECT_HW_ALGO;
        ret = true;
      }
      else if(strcasecmp(str, "NX_VISUALIZE_ACTIVE_VERTICES") == 0)
      {
        v = NX_VISUALIZE_ACTIVE_VERTICES;
        ret = true;
      }
      else if(strcasecmp(str, "NX_CCD_EPSILON") == 0)
      {
        v = NX_CCD_EPSILON;
        ret = true;
      }
      else if(strcasecmp(str, "NX_SOLVER_CONVERGENCE_THRESHOLD") == 0)
      {
        v = NX_SOLVER_CONVERGENCE_THRESHOLD;
        ret = true;
      }
      else if(strcasecmp(str, "NX_BBOX_NOISE_LEVEL") == 0)
      {
        v = NX_BBOX_NOISE_LEVEL;
        ret = true;
      }

#if NX_SDK_VERSION_NUMBER >= 250
      else if(strcasecmp(str, "NX_IMPLICIT_SWEEP_CACHE_SIZE") == 0)
      {
        v = NX_IMPLICIT_SWEEP_CACHE_SIZE;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER >= 260
      else if(strcasecmp(str, "NX_DEFAULT_SLEEP_ENERGY") == 0)
      {
        v = NX_DEFAULT_SLEEP_ENERGY;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER >= 270
      else if(strcasecmp(str, "NX_CONSTANT_FLUID_MAX_PACKETS") == 0)
      {
        v = NX_CONSTANT_FLUID_MAX_PACKETS;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER >= 270
      else if(strcasecmp(str, "NX_CONSTANT_FLUID_MAX_PARTICLES_PER_STEP") == 0)
      {
        v = NX_CONSTANT_FLUID_MAX_PARTICLES_PER_STEP;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER == 250 || NX_SDK_VERSION_NUMBER == 251
      else if(strcasecmp(str, "NX_GRID_HASH_CELL_SIZE") == 0)
      {
        v = NX_GRID_HASH_CELL_SIZE;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER >= 270
      else if(strcasecmp(str, "NX_VISUALIZE_CLOTH_TEARABLE_VERTICES") == 0)
      {
        v = NX_VISUALIZE_CLOTH_TEARABLE_VERTICES;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER >= 270
      else if(strcasecmp(str, "NX_VISUALIZE_CLOTH_TEARING") == 0)
      {
        v = NX_VISUALIZE_CLOTH_TEARING;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER >= 270
      else if(strcasecmp(str, "NX_VISUALIZE_CLOTH_ATTACHMENT") == 0)
      {
        v = NX_VISUALIZE_CLOTH_ATTACHMENT;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER >= 270
      else if(strcasecmp(str, "NX_VISUALIZE_SOFTBODY_MESH") == 0)
      {
        v = NX_VISUALIZE_SOFTBODY_MESH;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER >= 270
      else if(strcasecmp(str, "NX_VISUALIZE_SOFTBODY_COLLISIONS") == 0)
      {
        v = NX_VISUALIZE_SOFTBODY_COLLISIONS;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER >= 270
      else if(strcasecmp(str, "NX_VISUALIZE_SOFTBODY_WORKPACKETS") == 0)
      {
        v = NX_VISUALIZE_SOFTBODY_WORKPACKETS;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER >= 270
      else if(strcasecmp(str, "NX_VISUALIZE_SOFTBODY_SLEEP") == 0)
      {
        v = NX_VISUALIZE_SOFTBODY_SLEEP;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER >= 270
      else if(strcasecmp(str, "NX_VISUALIZE_SOFTBODY_TEARABLE_VERTICES") == 0)
      {
        v = NX_VISUALIZE_SOFTBODY_TEARABLE_VERTICES;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER >= 270
      else if(strcasecmp(str, "NX_VISUALIZE_SOFTBODY_TEARING") == 0)
      {
        v = NX_VISUALIZE_SOFTBODY_TEARING;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER >= 270
      else if(strcasecmp(str, "NX_VISUALIZE_SOFTBODY_ATTACHMENT") == 0)
      {
        v = NX_VISUALIZE_SOFTBODY_ATTACHMENT;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER >= 270
      else if(strcasecmp(str, "NX_VISUALIZE_FLUID_PACKET_DATA") == 0)
      {
        v = NX_VISUALIZE_FLUID_PACKET_DATA;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER >= 272
      else if(strcasecmp(str, "NX_VISUALIZE_FORCE_FIELDS") == 0)
      {
        v = NX_VISUALIZE_FORCE_FIELDS;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER >= 272
      else if(strcasecmp(str, "NX_VISUALIZE_CLOTH_VALIDBOUNDS") == 0)
      {
        v = NX_VISUALIZE_CLOTH_VALIDBOUNDS;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER >= 272
      else if(strcasecmp(str, "NX_VISUALIZE_SOFTBODY_VALIDBOUNDS") == 0)
      {
        v = NX_VISUALIZE_SOFTBODY_VALIDBOUNDS;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER >= 272
      else if(strcasecmp(str, "NX_VISUALIZE_CLOTH_SLEEP_VERTEX") == 0)
      {
        v = NX_VISUALIZE_CLOTH_SLEEP_VERTEX;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER >= 272
      else if(strcasecmp(str, "NX_VISUALIZE_SOFTBODY_SLEEP_VERTEX") == 0)
      {
        v = NX_VISUALIZE_SOFTBODY_SLEEP_VERTEX;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER >= 272
      else if(strcasecmp(str, "NX_ASYNCHRONOUS_MESH_CREATION") == 0)
      {
        v = NX_ASYNCHRONOUS_MESH_CREATION;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER >= 280
      else if(strcasecmp(str, "NX_FORCE_FIELD_CUSTOM_KERNEL_EPSILON") == 0)
      {
        v = NX_FORCE_FIELD_CUSTOM_KERNEL_EPSILON;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER >= 281
      else if(strcasecmp(str, "NX_IMPROVED_SPRING_SOLVER") == 0)
      {
        v = NX_IMPROVED_SPRING_SOLVER;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER >= 281
      else if(strcasecmp(str, "NX_FAST_MASSIVE_BP_VOLUME_DELETION") == 0)
      {
        v = NX_FAST_MASSIVE_BP_VOLUME_DELETION;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER >= 281
      else if(strcasecmp(str, "NX_LEGACY_JOINT_DRIVE") == 0)
      {
        v = NX_LEGACY_JOINT_DRIVE;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER >= 283
      else if(strcasecmp(str, "NX_VISUALIZE_CLOTH_HIERARCHY") == 0)
      {
        v = NX_VISUALIZE_CLOTH_HIERARCHY;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER >= 283
      else if(strcasecmp(str, "NX_VISUALIZE_CLOTH_HARD_STRETCHING_LIMITATION") == 0)
      {
        v = NX_VISUALIZE_CLOTH_HARD_STRETCHING_LIMITATION;
        ret = true;
      }

#endif
      else if(strcasecmp(str, "NX_PARAMS_NUM_VALUES") == 0)
      {
        v = NX_PARAMS_NUM_VALUES;
        ret = true;
      }
    }
  ...
  bool         StringToEnum(const char *str, NxCompartmentType &v)
  {
    ...
    if(str)
    {
      ...
      else if(strcasecmp(str, "NX_SCT_RIGIDBODY") == 0)
      {
        v = NX_SCT_RIGIDBODY;
        ret = true;
      }
      else if(strcasecmp(str, "NX_SCT_FLUID") == 0)
      {
        v = NX_SCT_FLUID;
        ret = true;
      }
      else if(strcasecmp(str, "NX_SCT_CLOTH") == 0)
      {
        v = NX_SCT_CLOTH;
        ret = true;
      }
  ...
  const char * EnumToString(NxPruningStructure v)
  {
    ...
    switch(v)
    {
      ...
      case NX_PRUNING_OCTREE:
        ret = "NX_PRUNING_OCTREE";
        break;
      case NX_PRUNING_QUADTREE:
        ret = "NX_PRUNING_QUADTREE";
        break;
      case NX_PRUNING_DYNAMIC_AABB_TREE:
        ret = "NX_PRUNING_DYNAMIC_AABB_TREE";
        break;
      case NX_PRUNING_STATIC_AABB_TREE:
        ret = "NX_PRUNING_STATIC_AABB_TREE";
        break;
      default:
        break;
    }
  ...
  bool         StringToEnum(const char *str, NxPruningStructure &v)
  {
    ...
    if(str)
    {
      ...
      else if(strcasecmp(str, "NX_PRUNING_NONE") == 0)
      {
        v = NX_PRUNING_NONE;
        ret = true;
      }
      else if(strcasecmp(str, "NX_PRUNING_OCTREE") == 0)
      {
        v = NX_PRUNING_OCTREE;
        ret = true;
      }
      else if(strcasecmp(str, "NX_PRUNING_QUADTREE") == 0)
      {
        v = NX_PRUNING_QUADTREE;
        ret = true;
      }
      else if(strcasecmp(str, "NX_PRUNING_DYNAMIC_AABB_TREE") == 0)
      {
        v = NX_PRUNING_DYNAMIC_AABB_TREE;
        ret = true;
      }
      else if(strcasecmp(str, "NX_PRUNING_STATIC_AABB_TREE") == 0)
      {
        v = NX_PRUNING_STATIC_AABB_TREE;
        ret = true;
      }
    }
  ...
  const char * EnumToString(NxBroadPhaseType v)
  {
    ...
    switch(v)
    {
      case NX_BP_TYPE_SAP_SINGLE:
        ret = "NX_BP_TYPE_SAP_SINGLE";
        break;
      case NX_BP_TYPE_SAP_MULTI:
        ret = "NX_BP_TYPE_SAP_MULTI";
        break;
      default:
        break;
    }
  ...
  bool         StringToEnum(const char *str, NxBroadPhaseType &v)
  {
    ...
    if(str)
    {
      ...
      else if(strcasecmp(str, "NX_BP_TYPE_SAP_SINGLE") == 0)
      {
        v = NX_BP_TYPE_SAP_SINGLE;
        ret = true;
      }
      else if(strcasecmp(str, "NX_BP_TYPE_SAP_MULTI") == 0)
      {
        v = NX_BP_TYPE_SAP_MULTI;
        ret = true;
      }
    }
  ...
  const char * EnumToString(NxCompartmentFlag v)
  {
    ...
    switch(v)
    {
      case NX_CF_SLEEP_NOTIFICATION:
        ret = "NX_CF_SLEEP_NOTIFICATION";
        break;
#if NX_SDK_VERSION_NUMBER >= 271
      case NX_CF_CONTINUOUS_CD:
        ret = "NX_CF_CONTINUOUS_CD";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 271
      case NX_CF_RESTRICTED_SCENE:
        ret = "NX_CF_RESTRICTED_SCENE";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 271
      case NX_CF_INHERIT_SETTINGS:
        ret = "NX_CF_INHERIT_SETTINGS";
        break;
#endif
      default:
        break;
  ...
  bool         StringToEnum(const char *str, NxCompartmentFlag &v)
  {
    ...
    else if(strcasecmp(str, "NX_CF_SLEEP_NOTIFICATION") == 0)
    {
      v = NX_CF_SLEEP_NOTIFICATION;
      ret = true;
    }

#if NX_SDK_VERSION_NUMBER >= 271
    else if(strcasecmp(str, "NX_CF_CONTINUOUS_CD") == 0)
    {
      v = NX_CF_CONTINUOUS_CD;
      ret = true;
    }

#endif
#if NX_SDK_VERSION_NUMBER >= 271
    else if(strcasecmp(str, "NX_CF_RESTRICTED_SCENE") == 0)
    {
      v = NX_CF_RESTRICTED_SCENE;
      ret = true;
    }

#endif
#if NX_SDK_VERSION_NUMBER >= 271
    else if(strcasecmp(str, "NX_CF_INHERIT_SETTINGS") == 0)
    {
      v = NX_CF_INHERIT_SETTINGS;
      ret = true;
    }
  ...
  const char * EnumToString(NxConvexFlags v)
  {
    ...
    switch(v)
    {
      case NX_CF_FLIPNORMALS:
        ret = "NX_CF_FLIPNORMALS";
        break;
      case NX_CF_16_BIT_INDICES:
        ret = "NX_CF_16_BIT_INDICES";
        break;
      case NX_CF_COMPUTE_CONVEX:
        ret = "NX_CF_COMPUTE_CONVEX";
        break;
      case NX_CF_INFLATE_CONVEX:
        ret = "NX_CF_INFLATE_CONVEX";
        break;
#if NX_SDK_VERSION_NUMBER < 280
      case NX_CF_USE_LEGACY_COOKER:
        ret = "NX_CF_USE_LEGACY_COOKER";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 280
      case NX_CF_DUMMY4:
...
#endif
#if NX_SDK_VERSION_NUMBER >= 250
      case NX_CF_USE_UNCOMPRESSED_NORMALS:
        ret = "NX_CF_USE_UNCOMPRESSED_NORMALS";
        break;
#endif
      default:
        break;
  ...
  bool         StringToEnum(const char *str, NxConvexFlags &v)
  {
    ...
    else if(strcasecmp(str, "NX_CF_FLIPNORMALS") == 0)
    {
      v = NX_CF_FLIPNORMALS;
      ret = true;
    }
    else if(strcasecmp(str, "NX_CF_16_BIT_INDICES") == 0)
    {
      v = NX_CF_16_BIT_INDICES;
      ret = true;
    }
    else if(strcasecmp(str, "NX_CF_COMPUTE_CONVEX") == 0)
    {
      v = NX_CF_COMPUTE_CONVEX;
      ret = true;
    }
    else if(strcasecmp(str, "NX_CF_INFLATE_CONVEX") == 0)
    {
      v = NX_CF_INFLATE_CONVEX;
      ret = true;
    }

#if NX_SDK_VERSION_NUMBER < 280
    else if(strcasecmp(str, "NX_CF_USE_LEGACY_COOKER") == 0)
    {
      v = NX_CF_USE_LEGACY_COOKER;
      ret = true;
    }

#endif
#if NX_SDK_VERSION_NUMBER >= 280
    else if(strcasecmp(str, "NX_CF_DUMMY4") == 0)
    {
      v = NX_CF_DUMMY4;
      ret = true;
    }
...
#endif
#if NX_SDK_VERSION_NUMBER >= 250
    else if(strcasecmp(str, "NX_CF_USE_UNCOMPRESSED_NORMALS") == 0)
    {
      v = NX_CF_USE_UNCOMPRESSED_NORMALS;
      ret = true;
    }
  ...
  bool         StringToEnum(const char *str, NxHeightFieldAxis &v)
  {
    ...
    if(str)
    {
      ...
      else if(strcasecmp(str, "NX_X") == 0)
      {
        v = NX_X;
        ret = true;
      }
      else if(strcasecmp(str, "NX_Y") == 0)
      {
        v = NX_Y;
        ret = true;
      }
      else if(strcasecmp(str, "NX_Z") == 0)
      {
        v = NX_Z;
        ret = true;
      }
  ...
  const char * EnumToString(NxMeshFlags v)
  {
    ...
    switch(v)
    {
      case NX_MF_FLIPNORMALS:
        ret = "NX_MF_FLIPNORMALS";
        break;
      case NX_MF_16_BIT_INDICES:
        ret = "NX_MF_16_BIT_INDICES";
        break;
      case NX_MF_HARDWARE_MESH:
        ret = "NX_MF_HARDWARE_MESH";
        break;
      default:
        break;
    }
  ...
  bool         StringToEnum(const char *str, NxMeshFlags &v)
  {
    ...
    else if(strcasecmp(str, "NX_MF_FLIPNORMALS") == 0)
    {
      v = NX_MF_FLIPNORMALS;
      ret = true;
    }
    else if(strcasecmp(str, "NX_MF_16_BIT_INDICES") == 0)
    {
      v = NX_MF_16_BIT_INDICES;
      ret = true;
    }
    else if(strcasecmp(str, "NX_MF_HARDWARE_MESH") == 0)
    {
      v = NX_MF_HARDWARE_MESH;
      ret = true;
    }
  ...
  const char * EnumToString(NxHeightFieldFlags v)
  {
    ...
    switch(v)
    {
      case NX_HF_NO_BOUNDARY_EDGES:
        ret = "NX_HF_NO_BOUNDARY_EDGES";
        break;
      default:
        break;
    }
  ...
  bool         StringToEnum(const char *str, NxHeightFieldFlags &v)
  {
    ...
    else if(strcasecmp(str, "NX_HF_NO_BOUNDARY_EDGES") == 0)
    {
      v = NX_HF_NO_BOUNDARY_EDGES;
      ret = true;
    }
  ...
  const char * EnumToString(NxClothMeshFlags v)
  {
    ...
    switch(v)
    {
      case NX_CLOTH_MESH_DUMMY0:
        ret = "NX_CLOTH_MESH_DUMMY0";
        break;
      case NX_CLOTH_MESH_DUMMY1:
        ret = "NX_CLOTH_MESH_DUMMY1";
        break;
      case NX_CLOTH_MESH_DUMMY2:
        ret = "NX_CLOTH_MESH_DUMMY2";
        break;
      case NX_CLOTH_MESH_DUMMY3:
        ret = "NX_CLOTH_MESH_DUMMY3";
        break;
      case NX_CLOTH_MESH_DUMMY4:
        ret = "NX_CLOTH_MESH_DUMMY4";
        break;
      case NX_CLOTH_MESH_DUMMY5:
        ret = "NX_CLOTH_MESH_DUMMY5";
        break;
      case NX_CLOTH_MESH_DUMMY6:
        ret = "NX_CLOTH_MESH_DUMMY6";
        break;
      case NX_CLOTH_MESH_DUMMY7:
        ret = "NX_CLOTH_MESH_DUMMY7";
        break;
      case NX_CLOTH_MESH_TEARABLE:
        ret = "NX_CLOTH_MESH_TEARABLE";
        break;
#if NX_SDK_VERSION_NUMBER >= 280
      case NX_CLOTH_MESH_WELD_VERTICES:
        ret = "NX_CLOTH_MESH_WELD_VERTICES";
        break;
#endif
      default:
        break;
  ...
  bool         StringToEnum(const char *str, NxClothMeshFlags &v)
  {
    ...
    else if(strcasecmp(str, "NX_CLOTH_MESH_DUMMY0") == 0)
    {
      v = NX_CLOTH_MESH_DUMMY0;
      ret = true;
    }
    else if(strcasecmp(str, "NX_CLOTH_MESH_DUMMY1") == 0)
    {
      v = NX_CLOTH_MESH_DUMMY1;
      ret = true;
    }
    else if(strcasecmp(str, "NX_CLOTH_MESH_DUMMY2") == 0)
    {
      v = NX_CLOTH_MESH_DUMMY2;
      ret = true;
    }
    else if(strcasecmp(str, "NX_CLOTH_MESH_DUMMY3") == 0)
    {
      v = NX_CLOTH_MESH_DUMMY3;
      ret = true;
    }
    else if(strcasecmp(str, "NX_CLOTH_MESH_DUMMY4") == 0)
    {
      v = NX_CLOTH_MESH_DUMMY4;
      ret = true;
    }
    else if(strcasecmp(str, "NX_CLOTH_MESH_DUMMY5") == 0)
    {
      v = NX_CLOTH_MESH_DUMMY5;
      ret = true;
    }
    else if(strcasecmp(str, "NX_CLOTH_MESH_DUMMY6") == 0)
    {
      v = NX_CLOTH_MESH_DUMMY6;
      ret = true;
    }
    else if(strcasecmp(str, "NX_CLOTH_MESH_DUMMY7") == 0)
    {
      v = NX_CLOTH_MESH_DUMMY7;
      ret = true;
    }
    else if(strcasecmp(str, "NX_CLOTH_MESH_TEARABLE") == 0)
    {
      v = NX_CLOTH_MESH_TEARABLE;
      ret = true;
    }

#if NX_SDK_VERSION_NUMBER >= 280
    else if(strcasecmp(str, "NX_CLOTH_MESH_WELD_VERTICES") == 0)
    {
      v = NX_CLOTH_MESH_WELD_VERTICES;
      ret = true;
    }
  ...
  const char * EnumToString(NxClothVertexFlags v)
  {
    ...
    switch(v)
    {
      case NX_CLOTH_VERTEX_DUMMY0:
        ret = "NX_CLOTH_VERTEX_DUMMY0";
        break;
      case NX_CLOTH_VERTEX_DUMMY1:
        ret = "NX_CLOTH_VERTEX_DUMMY1";
        break;
      case NX_CLOTH_VERTEX_DUMMY2:
        ret = "NX_CLOTH_VERTEX_DUMMY2";
        break;
      case NX_CLOTH_VERTEX_DUMMY3:
        ret = "NX_CLOTH_VERTEX_DUMMY3";
        break;
      case NX_CLOTH_VERTEX_DUMMY4:
        ret = "NX_CLOTH_VERTEX_DUMMY4";
        break;
      case NX_CLOTH_VERTEX_DUMMY5:
        ret = "NX_CLOTH_VERTEX_DUMMY5";
        break;
      case NX_CLOTH_VERTEX_DUMMY6:
        ret = "NX_CLOTH_VERTEX_DUMMY6";
        break;
      case NX_CLOTH_VERTEX_TEARABLE:
        ret = "NX_CLOTH_VERTEX_TEARABLE";
        break;
      default:
        break;
    }
  ...
  bool         StringToEnum(const char *str, NxClothVertexFlags &v)
  {
    ...
    else if(strcasecmp(str, "NX_CLOTH_VERTEX_DUMMY0") == 0)
    {
      v = NX_CLOTH_VERTEX_DUMMY0;
      ret = true;
    }
    else if(strcasecmp(str, "NX_CLOTH_VERTEX_DUMMY1") == 0)
    {
      v = NX_CLOTH_VERTEX_DUMMY1;
      ret = true;
    }
    else if(strcasecmp(str, "NX_CLOTH_VERTEX_DUMMY2") == 0)
    {
      v = NX_CLOTH_VERTEX_DUMMY2;
      ret = true;
    }
    else if(strcasecmp(str, "NX_CLOTH_VERTEX_DUMMY3") == 0)
    {
      v = NX_CLOTH_VERTEX_DUMMY3;
      ret = true;
    }
    else if(strcasecmp(str, "NX_CLOTH_VERTEX_DUMMY4") == 0)
    {
      v = NX_CLOTH_VERTEX_DUMMY4;
      ret = true;
    }
    else if(strcasecmp(str, "NX_CLOTH_VERTEX_DUMMY5") == 0)
    {
      v = NX_CLOTH_VERTEX_DUMMY5;
      ret = true;
    }
    else if(strcasecmp(str, "NX_CLOTH_VERTEX_DUMMY6") == 0)
    {
      v = NX_CLOTH_VERTEX_DUMMY6;
      ret = true;
    }
    else if(strcasecmp(str, "NX_CLOTH_VERTEX_TEARABLE") == 0)
    {
      v = NX_CLOTH_VERTEX_TEARABLE;
      ret = true;
    }
  ...
  bool         StringToEnum(const char *str, NxFilterOp &v)
  {
    ...
    if(str)
    {
      ...
      else if(strcasecmp(str, "NX_FILTEROP_AND") == 0)
      {
        v = NX_FILTEROP_AND;
        ret = true;
      }
      else if(strcasecmp(str, "NX_FILTEROP_OR") == 0)
      {
        v = NX_FILTEROP_OR;
        ret = true;
      }
      else if(strcasecmp(str, "NX_FILTEROP_XOR") == 0)
      {
        v = NX_FILTEROP_XOR;
        ret = true;
      }
      else if(strcasecmp(str, "NX_FILTEROP_NAND") == 0)
      {
        v = NX_FILTEROP_NAND;
        ret = true;
      }
      else if(strcasecmp(str, "NX_FILTEROP_NOR") == 0)
      {
        v = NX_FILTEROP_NOR;
        ret = true;
      }
      else if(strcasecmp(str, "NX_FILTEROP_NXOR") == 0)
      {
        v = NX_FILTEROP_NXOR;
        ret = true;
      }
      else if(strcasecmp(str, "NX_FILTEROP_SWAP_AND") == 0)
      {
        v = NX_FILTEROP_SWAP_AND;
        ret = true;
      }
    }
  ...
  const char * EnumToString(NxTimeStepMethod v)
  {
    ...
    switch(v)
    {
      case NX_TIMESTEP_FIXED:
        ret = "NX_TIMESTEP_FIXED";
        break;
      case NX_TIMESTEP_VARIABLE:
        ret = "NX_TIMESTEP_VARIABLE";
        break;
      default:
        break;
    }
  ...
  bool         StringToEnum(const char *str, NxTimeStepMethod &v)
  {
    ...
    if(str)
    {
      ...
      else if(strcasecmp(str, "NX_TIMESTEP_FIXED") == 0)
      {
        v = NX_TIMESTEP_FIXED;
        ret = true;
      }
      else if(strcasecmp(str, "NX_TIMESTEP_VARIABLE") == 0)
      {
        v = NX_TIMESTEP_VARIABLE;
        ret = true;
      }
    }
  ...
  const char * EnumToString(NxSimulationType v)
  {
    ...
    switch(v)
    {
      case NX_SIMULATION_SW:
        ret = "NX_SIMULATION_SW";
        break;
      case NX_SIMULATION_HW:
        ret = "NX_SIMULATION_HW";
        break;
      default:
        break;
    }
  ...
  bool         StringToEnum(const char *str, NxSimulationType &v)
  {
    ...
    if(str)
    {
      ...
      else if(strcasecmp(str, "NX_SIMULATION_SW") == 0)
      {
        v = NX_SIMULATION_SW;
        ret = true;
      }
      else if(strcasecmp(str, "NX_SIMULATION_HW") == 0)
      {
        v = NX_SIMULATION_HW;
        ret = true;
      }
  ...
  const char * EnumToString(NxThreadPriority v)
  {
    ...
    switch(v)
    {
      case NX_TP_HIGH:
        ...
        break;
#if NX_SDK_VERSION_NUMBER >= 271
      case NX_TP_ABOVE_NORMAL:
        ret = "NX_TP_ABOVE_NORMAL";
        break;
#endif
      case NX_TP_NORMAL:
        ret = "NX_TP_NORMAL";
        break;
#if NX_SDK_VERSION_NUMBER >= 271
      case NX_TP_BELOW_NORMAL:
        ret = "NX_TP_BELOW_NORMAL";
        break;
#endif
      case NX_TP_LOW:
        ret = "NX_TP_LOW";
  ...
  bool         StringToEnum(const char *str, NxThreadPriority &v)
  {
    ...
    if(str)
    {
      ...
      else if(strcasecmp(str, "NX_TP_HIGH") == 0)
      {
        v = NX_TP_HIGH;
        ret = true;
      }
...
#if NX_SDK_VERSION_NUMBER >= 271
      else if(strcasecmp(str, "NX_TP_ABOVE_NORMAL") == 0)
      {
        v = NX_TP_ABOVE_NORMAL;
        ret = true;
      }

#endif
      else if(strcasecmp(str, "NX_TP_NORMAL") == 0)
      {
        v = NX_TP_NORMAL;
        ret = true;
      }
...
#if NX_SDK_VERSION_NUMBER >= 271
      else if(strcasecmp(str, "NX_TP_BELOW_NORMAL") == 0)
      {
        v = NX_TP_BELOW_NORMAL;
        ret = true;
      }

#endif
      else if(strcasecmp(str, "NX_TP_LOW") == 0)
      {
        v = NX_TP_LOW;
        ret = true;
      }
  ...
  const char * EnumToString(NxSceneFlags v)
  {
    ...
    switch(v)
    {
      case NX_SF_DISABLE_SSE:
        ret = "NX_SF_DISABLE_SSE";
        break;
      case NX_SF_DISABLE_COLLISIONS:
        ret = "NX_SF_DISABLE_COLLISIONS";
        break;
      case NX_SF_SIMULATE_SEPARATE_THREAD:
        ret = "NX_SF_SIMULATE_SEPARATE_THREAD";
        break;
      case NX_SF_ENABLE_MULTITHREAD:
        ret = "NX_SF_ENABLE_MULTITHREAD";
        break;
#if NX_SDK_VERSION_NUMBER >= 250
      case NX_SF_ENABLE_ACTIVETRANSFORMS:
        ret = "NX_SF_ENABLE_ACTIVETRANSFORMS";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 250
      case NX_SF_RESTRICTED_SCENE:
        ret = "NX_SF_RESTRICTED_SCENE";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 250
      case NX_SF_DISABLE_SCENE_MUTEX:
        ret = "NX_SF_DISABLE_SCENE_MUTEX";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 261
      case NX_SF_FORCE_CONE_FRICTION:
        ret = "NX_SF_FORCE_CONE_FRICTION";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 263
      case NX_SF_SEQUENTIAL_PRIMARY:
        ret = "NX_SF_SEQUENTIAL_PRIMARY";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 263
      case NX_SF_FLUID_PERFORMANCE_HINT:
        ret = "NX_SF_FLUID_PERFORMANCE_HINT";
        break;
#endif
      default:
        break;
  ...
  bool         StringToEnum(const char *str, NxSceneFlags &v)
  {
    ...
    else if(strcasecmp(str, "NX_SF_DISABLE_SSE") == 0)
    {
      v = NX_SF_DISABLE_SSE;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SF_DISABLE_COLLISIONS") == 0)
    {
      v = NX_SF_DISABLE_COLLISIONS;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SF_SIMULATE_SEPARATE_THREAD") == 0)
    {
      v = NX_SF_SIMULATE_SEPARATE_THREAD;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SF_ENABLE_MULTITHREAD") == 0)
    {
      v = NX_SF_ENABLE_MULTITHREAD;
      ret = true;
    }

#if NX_SDK_VERSION_NUMBER >= 250
    else if(strcasecmp(str, "NX_SF_ENABLE_ACTIVETRANSFORMS") == 0)
    {
      v = NX_SF_ENABLE_ACTIVETRANSFORMS;
      ret = true;
    }

#endif
#if NX_SDK_VERSION_NUMBER >= 250
    else if(strcasecmp(str, "NX_SF_RESTRICTED_SCENE") == 0)
    {
      v = NX_SF_RESTRICTED_SCENE;
      ret = true;
    }

#endif
#if NX_SDK_VERSION_NUMBER >= 250
    else if(strcasecmp(str, "NX_SF_DISABLE_SCENE_MUTEX") == 0)
    {
      v = NX_SF_DISABLE_SCENE_MUTEX;
      ret = true;
    }

#endif
#if NX_SDK_VERSION_NUMBER >= 261
    else if(strcasecmp(str, "NX_SF_FORCE_CONE_FRICTION") == 0)
    {
      v = NX_SF_FORCE_CONE_FRICTION;
      ret = true;
    }

#endif
#if NX_SDK_VERSION_NUMBER >= 263
    else if(strcasecmp(str, "NX_SF_SEQUENTIAL_PRIMARY") == 0)
    {
      v = NX_SF_SEQUENTIAL_PRIMARY;
      ret = true;
    }

#endif
#if NX_SDK_VERSION_NUMBER >= 263
    else if(strcasecmp(str, "NX_SF_FLUID_PERFORMANCE_HINT") == 0)
    {
      v = NX_SF_FLUID_PERFORMANCE_HINT;
      ret = true;
    }
  ...
  bool         StringToEnum(const char *str, NxCombineMode &v)
  {
    ...
    if(str)
    {
      ...
      else if(strcasecmp(str, "NX_CM_AVERAGE") == 0)
      {
        v = NX_CM_AVERAGE;
        ret = true;
      }
      else if(strcasecmp(str, "NX_CM_MIN") == 0)
      {
        v = NX_CM_MIN;
        ret = true;
      }
      else if(strcasecmp(str, "NX_CM_MULTIPLY") == 0)
      {
        v = NX_CM_MULTIPLY;
        ret = true;
      }
      else if(strcasecmp(str, "NX_CM_MAX") == 0)
      {
        v = NX_CM_MAX;
        ret = true;
      }
  ...
  const char * EnumToString(NxMaterialFlag v)
  {
    ...
    switch(v)
    {
      case NX_MF_ANISOTROPIC:
        ret = "NX_MF_ANISOTROPIC";
        break;
      case NX_MF_DUMMY1:
        ret = "NX_MF_DUMMY1";
        break;
      ...
      case NX_MF_DUMMY3:
        ret = "NX_MF_DUMMY3";
        break;
      case NX_MF_DISABLE_FRICTION:
        ret = "NX_MF_DISABLE_FRICTION";
        break;
      case NX_MF_DISABLE_STRONG_FRICTION:
        ret = "NX_MF_DISABLE_STRONG_FRICTION";
        break;
      default:
        break;
    }
  ...
  bool         StringToEnum(const char *str, NxMaterialFlag &v)
  {
    ...
    else if(strcasecmp(str, "NX_MF_ANISOTROPIC") == 0)
    {
      v = NX_MF_ANISOTROPIC;
      ret = true;
    }
    else if(strcasecmp(str, "NX_MF_DUMMY1") == 0)
    {
      v = NX_MF_DUMMY1;
      ret = true;
    }
    else if(strcasecmp(str, "NX_MF_DUMMY2") == 0)
    {
      v = NX_MF_DUMMY2;
      ret = true;
    }
    else if(strcasecmp(str, "NX_MF_DUMMY3") == 0)
    {
      v = NX_MF_DUMMY3;
      ret = true;
    }
    else if(strcasecmp(str, "NX_MF_DISABLE_FRICTION") == 0)
    {
      v = NX_MF_DISABLE_FRICTION;
      ret = true;
    }
    else if(strcasecmp(str, "NX_MF_DISABLE_STRONG_FRICTION") == 0)
    {
      v = NX_MF_DISABLE_STRONG_FRICTION;
      ret = true;
    }
  ...
  const char * EnumToString(NxBodyFlag v)
  {
    ...
    switch(v)
    {
      case NX_BF_DISABLE_GRAVITY:
        ret = "NX_BF_DISABLE_GRAVITY";
        break;
      case NX_BF_FROZEN_POS_X:
        ret = "NX_BF_FROZEN_POS_X";
        break;
      case NX_BF_FROZEN_POS_Y:
        ret = "NX_BF_FROZEN_POS_Y";
        break;
      case NX_BF_FROZEN_POS_Z:
        ret = "NX_BF_FROZEN_POS_Z";
        break;
      case NX_BF_FROZEN_ROT_X:
        ret = "NX_BF_FROZEN_ROT_X";
        break;
      case NX_BF_FROZEN_ROT_Y:
        ret = "NX_BF_FROZEN_ROT_Y";
        break;
      case NX_BF_FROZEN_ROT_Z:
        ret = "NX_BF_FROZEN_ROT_Z";
        break;
      case NX_BF_KINEMATIC:
        ret = "NX_BF_KINEMATIC";
        break;
      case NX_BF_VISUALIZATION:
        ret = "NX_BF_VISUALIZATION";
        break;
      case NX_BF_DUMMY_0:
        ret = "NX_BF_DUMMY_0";
        break;
      case NX_BF_FILTER_SLEEP_VEL:
        ret = "NX_BF_FILTER_SLEEP_VEL";
        break;
#if NX_SDK_VERSION_NUMBER >= 250
      case NX_BF_ENERGY_SLEEP_TEST:
        ret = "NX_BF_ENERGY_SLEEP_TEST";
        break;
#endif
      default:
        break;
  ...
  bool         StringToEnum(const char *str, NxBodyFlag &v)
  {
    ...
    else if(strcasecmp(str, "NX_BF_DISABLE_GRAVITY") == 0)
    {
      v = NX_BF_DISABLE_GRAVITY;
      ret = true;
    }
    else if(strcasecmp(str, "NX_BF_FROZEN_POS_X") == 0)
    {
      v = NX_BF_FROZEN_POS_X;
      ret = true;
    }
    else if(strcasecmp(str, "NX_BF_FROZEN_POS_Y") == 0)
    {
      v = NX_BF_FROZEN_POS_Y;
      ret = true;
    }
    else if(strcasecmp(str, "NX_BF_FROZEN_POS_Z") == 0)
    {
      v = NX_BF_FROZEN_POS_Z;
      ret = true;
    }
    else if(strcasecmp(str, "NX_BF_FROZEN_ROT_X") == 0)
    {
      v = NX_BF_FROZEN_ROT_X;
      ret = true;
    }
    else if(strcasecmp(str, "NX_BF_FROZEN_ROT_Y") == 0)
    {
      v = NX_BF_FROZEN_ROT_Y;
      ret = true;
    }
    else if(strcasecmp(str, "NX_BF_FROZEN_ROT_Z") == 0)
    {
      v = NX_BF_FROZEN_ROT_Z;
      ret = true;
    }
    else if(strcasecmp(str, "NX_BF_KINEMATIC") == 0)
    {
      v = NX_BF_KINEMATIC;
      ret = true;
    }
    else if(strcasecmp(str, "NX_BF_VISUALIZATION") == 0)
    {
      v = NX_BF_VISUALIZATION;
      ret = true;
    }
    else if(strcasecmp(str, "NX_BF_DUMMY_0") == 0)
    {
      v = NX_BF_DUMMY_0;
      ret = true;
    }
    else if(strcasecmp(str, "NX_BF_FILTER_SLEEP_VEL") == 0)
    {
      v = NX_BF_FILTER_SLEEP_VEL;
      ret = true;
    }

#if NX_SDK_VERSION_NUMBER >= 250
    else if(strcasecmp(str, "NX_BF_ENERGY_SLEEP_TEST") == 0)
    {
      v = NX_BF_ENERGY_SLEEP_TEST;
      ret = true;
    }
  ...
  const char * EnumToString(NxActorFlag v)
  {
    ...
    switch(v)
    {
      case NX_AF_DISABLE_COLLISION:
        ret = "NX_AF_DISABLE_COLLISION";
        break;
      case NX_AF_DISABLE_RESPONSE:
        ret = "NX_AF_DISABLE_RESPONSE";
        break;
      case NX_AF_LOCK_COM:
        ret = "NX_AF_LOCK_COM";
        break;
      case NX_AF_FLUID_DISABLE_COLLISION:
        ret = "NX_AF_FLUID_DISABLE_COLLISION";
        break;
#if NX_SDK_VERSION_NUMBER < 250
      case NX_AF_FLUID_ACTOR_REACTION:
        ret = "NX_AF_FLUID_ACTOR_REACTION";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 250
      case NX_AF_CONTACT_MODIFICATION:
        ret = "NX_AF_CONTACT_MODIFICATION";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 261
      case NX_AF_FORCE_CONE_FRICTION:
        ret = "NX_AF_FORCE_CONE_FRICTION";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 270
      case NX_AF_USER_ACTOR_PAIR_FILTERING:
        ret = "NX_AF_USER_ACTOR_PAIR_FILTERING";
        break;
#endif
      default:
        break;
  ...
  bool         StringToEnum(const char *str, NxActorFlag &v)
  {
    ...
    else if(strcasecmp(str, "NX_AF_DISABLE_COLLISION") == 0)
    {
      v = NX_AF_DISABLE_COLLISION;
      ret = true;
    }
    else if(strcasecmp(str, "NX_AF_DISABLE_RESPONSE") == 0)
    {
      v = NX_AF_DISABLE_RESPONSE;
      ret = true;
    }
    else if(strcasecmp(str, "NX_AF_LOCK_COM") == 0)
    {
      v = NX_AF_LOCK_COM;
      ret = true;
    }
    else if(strcasecmp(str, "NX_AF_FLUID_DISABLE_COLLISION") == 0)
    {
      v = NX_AF_FLUID_DISABLE_COLLISION;
      ret = true;
    }

#if NX_SDK_VERSION_NUMBER < 250
    else if(strcasecmp(str, "NX_AF_FLUID_ACTOR_REACTION") == 0)
    {
      v = NX_AF_FLUID_ACTOR_REACTION;
      ret = true;
    }

#endif
#if NX_SDK_VERSION_NUMBER >= 250
    else if(strcasecmp(str, "NX_AF_CONTACT_MODIFICATION") == 0)
    {
      v = NX_AF_CONTACT_MODIFICATION;
      ret = true;
    }

#endif
#if NX_SDK_VERSION_NUMBER >= 261
    else if(strcasecmp(str, "NX_AF_FORCE_CONE_FRICTION") == 0)
    {
      v = NX_AF_FORCE_CONE_FRICTION;
      ret = true;
    }

#endif
#if NX_SDK_VERSION_NUMBER >= 270
    else if(strcasecmp(str, "NX_AF_USER_ACTOR_PAIR_FILTERING") == 0)
    {
      v = NX_AF_USER_ACTOR_PAIR_FILTERING;
      ret = true;
    }
  ...
  bool         StringToEnum(const char *str, NxShapeType &v)
  {
    ...
    if(str)
    {
      ...
      else if(strcasecmp(str, "NX_SHAPE_PLANE") == 0)
      {
        v = NX_SHAPE_PLANE;
        ret = true;
      }
      else if(strcasecmp(str, "NX_SHAPE_SPHERE") == 0)
      {
        v = NX_SHAPE_SPHERE;
        ret = true;
      }
      else if(strcasecmp(str, "NX_SHAPE_BOX") == 0)
      {
        v = NX_SHAPE_BOX;
        ret = true;
      }
      else if(strcasecmp(str, "NX_SHAPE_CAPSULE") == 0)
      {
        v = NX_SHAPE_CAPSULE;
        ret = true;
      }
      else if(strcasecmp(str, "NX_SHAPE_WHEEL") == 0)
      {
        v = NX_SHAPE_WHEEL;
        ret = true;
      }
      else if(strcasecmp(str, "NX_SHAPE_CONVEX") == 0)
      {
        v = NX_SHAPE_CONVEX;
        ret = true;
      }
      else if(strcasecmp(str, "NX_SHAPE_MESH") == 0)
      {
        v = NX_SHAPE_MESH;
        ret = true;
      }
      else if(strcasecmp(str, "NX_SHAPE_HEIGHTFIELD") == 0)
      {
        v = NX_SHAPE_HEIGHTFIELD;
        ret = true;
      }
    }
  ...
  const char * EnumToString(NxShapeCompartmentType v)
  {
    ...
    switch(v)
    {
      case NX_COMPARTMENT_SW_RIGIDBODY:
        ret = "NX_COMPARTMENT_SW_RIGIDBODY";
        break;
      case NX_COMPARTMENT_HW_RIGIDBODY:
        ret = "NX_COMPARTMENT_HW_RIGIDBODY";
        break;
      case NX_COMPARTMENT_SW_FLUID:
        ret = "NX_COMPARTMENT_SW_FLUID";
        break;
      case NX_COMPARTMENT_HW_FLUID:
        ret = "NX_COMPARTMENT_HW_FLUID";
        break;
      case NX_COMPARTMENT_SW_CLOTH:
        ret = "NX_COMPARTMENT_SW_CLOTH";
        break;
      case NX_COMPARTMENT_HW_CLOTH:
        ret = "NX_COMPARTMENT_HW_CLOTH";
        break;
      case NX_COMPARTMENT_SW_SOFTBODY:
        ret = "NX_COMPARTMENT_SW_SOFTBODY";
        break;
      case NX_COMPARTMENT_HW_SOFTBODY:
        ret = "NX_COMPARTMENT_HW_SOFTBODY";
        break;
      default:
        break;
    }
  ...
  bool         StringToEnum(const char *str, NxShapeCompartmentType &v)
  {
    ...
    else if(strcasecmp(str, "NX_COMPARTMENT_SW_RIGIDBODY") == 0)
    {
      v = NX_COMPARTMENT_SW_RIGIDBODY;
      ret = true;
    }
    else if(strcasecmp(str, "NX_COMPARTMENT_HW_RIGIDBODY") == 0)
    {
      v = NX_COMPARTMENT_HW_RIGIDBODY;
      ret = true;
    }
    else if(strcasecmp(str, "NX_COMPARTMENT_SW_FLUID") == 0)
    {
      v = NX_COMPARTMENT_SW_FLUID;
      ret = true;
    }
    else if(strcasecmp(str, "NX_COMPARTMENT_HW_FLUID") == 0)
    {
      v = NX_COMPARTMENT_HW_FLUID;
      ret = true;
    }
    else if(strcasecmp(str, "NX_COMPARTMENT_SW_CLOTH") == 0)
    {
      v = NX_COMPARTMENT_SW_CLOTH;
      ret = true;
    }
    else if(strcasecmp(str, "NX_COMPARTMENT_HW_CLOTH") == 0)
    {
      v = NX_COMPARTMENT_HW_CLOTH;
      ret = true;
    }
    else if(strcasecmp(str, "NX_COMPARTMENT_SW_SOFTBODY") == 0)
    {
      v = NX_COMPARTMENT_SW_SOFTBODY;
      ret = true;
    }
    else if(strcasecmp(str, "NX_COMPARTMENT_HW_SOFTBODY") == 0)
    {
      v = NX_COMPARTMENT_HW_SOFTBODY;
      ret = true;
    }
  ...
  const char * EnumToString(NxShapeFlag v)
  {
    ...
    switch(v)
    {
      case NX_TRIGGER_ON_ENTER:
        ret = "NX_TRIGGER_ON_ENTER";
        break;
      case NX_TRIGGER_ON_LEAVE:
        ret = "NX_TRIGGER_ON_LEAVE";
        break;
      case NX_TRIGGER_ON_STAY:
        ret = "NX_TRIGGER_ON_STAY";
        break;
      case NX_SF_VISUALIZATION:
        ret = "NX_SF_VISUALIZATION";
        break;
      case NX_SF_DISABLE_COLLISION:
        ret = "NX_SF_DISABLE_COLLISION";
        break;
      case NX_SF_FEATURE_INDICES:
        ret = "NX_SF_FEATURE_INDICES";
        break;
      case NX_SF_DISABLE_RAYCASTING:
        ret = "NX_SF_DISABLE_RAYCASTING";
        break;
      case NX_SF_POINT_CONTACT_FORCE:
        ret = "NX_SF_POINT_CONTACT_FORCE";
        break;
      case NX_SF_FLUID_DRAIN:
        ret = "NX_SF_FLUID_DRAIN";
        break;
      case NX_SF_FLUID_DUMMY9:
        ret = "NX_SF_FLUID_DUMMY9";
        break;
      case NX_SF_FLUID_DISABLE_COLLISION:
        ret = "NX_SF_FLUID_DISABLE_COLLISION";
        break;
#if NX_SDK_VERSION_NUMBER >= 250
      case NX_SF_FLUID_TWOWAY:
        ret = "NX_SF_FLUID_TWOWAY";
        break;
#endif
      case NX_SF_DISABLE_RESPONSE:
        ret = "NX_SF_DISABLE_RESPONSE";
        break;
      case NX_SF_DYNAMIC_DYNAMIC_CCD:
        ret = "NX_SF_DYNAMIC_DYNAMIC_CCD";
        break;
#if NX_SDK_VERSION_NUMBER >= 250
      case NX_SF_DISABLE_SCENE_QUERIES:
        ret = "NX_SF_DISABLE_SCENE_QUERIES";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 270
      case NX_SF_CLOTH_DRAIN:
        ret = "NX_SF_CLOTH_DRAIN";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 270
      case NX_SF_CLOTH_DISABLE_COLLISION:
        ret = "NX_SF_CLOTH_DISABLE_COLLISION";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 270
      case NX_SF_CLOTH_TWOWAY:
        ret = "NX_SF_CLOTH_TWOWAY";
        break;
#endif
#if NX_USE_SOFTBODY_API
      case NX_SF_SOFTBODY_DRAIN:
        ret = "NX_SF_SOFTBODY_DRAIN";
        break;
#endif
#if NX_USE_SOFTBODY_API
      case NX_SF_SOFTBODY_DISABLE_COLLISION:
        ret = "NX_SF_SOFTBODY_DISABLE_COLLISION";
        break;
#endif
#if NX_USE_SOFTBODY_API
      case NX_SF_SOFTBODY_TWOWAY:
        ret = "NX_SF_SOFTBODY_TWOWAY";
        break;
#endif
      default:
        break;
  ...
  bool         StringToEnum(const char *str, NxShapeFlag &v)
  {
    ...
    else if(strcasecmp(str, "NX_TRIGGER_ON_ENTER") == 0)
    {
      v = NX_TRIGGER_ON_ENTER;
      ret = true;
    }
    else if(strcasecmp(str, "NX_TRIGGER_ON_LEAVE") == 0)
    {
      v = NX_TRIGGER_ON_LEAVE;
      ret = true;
    }
    else if(strcasecmp(str, "NX_TRIGGER_ON_STAY") == 0)
    {
      v = NX_TRIGGER_ON_STAY;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SF_VISUALIZATION") == 0)
    {
      v = NX_SF_VISUALIZATION;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SF_DISABLE_COLLISION") == 0)
    {
      v = NX_SF_DISABLE_COLLISION;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SF_FEATURE_INDICES") == 0)
    {
      v = NX_SF_FEATURE_INDICES;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SF_DISABLE_RAYCASTING") == 0)
    {
      v = NX_SF_DISABLE_RAYCASTING;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SF_POINT_CONTACT_FORCE") == 0)
    {
      v = NX_SF_POINT_CONTACT_FORCE;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SF_FLUID_DRAIN") == 0)
    {
      v = NX_SF_FLUID_DRAIN;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SF_FLUID_DUMMY9") == 0)
    {
      v = NX_SF_FLUID_DUMMY9;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SF_FLUID_DISABLE_COLLISION") == 0)
    {
      v = NX_SF_FLUID_DISABLE_COLLISION;
      ret = true;
    }

#if NX_SDK_VERSION_NUMBER >= 250
    else if(strcasecmp(str, "NX_SF_FLUID_TWOWAY") == 0)
    {
      v = NX_SF_FLUID_TWOWAY;
      ret = true;
    }

#endif
    else if(strcasecmp(str, "NX_SF_DISABLE_RESPONSE") == 0)
    {
      v = NX_SF_DISABLE_RESPONSE;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SF_DYNAMIC_DYNAMIC_CCD") == 0)
    {
      v = NX_SF_DYNAMIC_DYNAMIC_CCD;
      ret = true;
    }

#if NX_SDK_VERSION_NUMBER >= 250
    else if(strcasecmp(str, "NX_SF_DISABLE_SCENE_QUERIES") == 0)
    {
      v = NX_SF_DISABLE_SCENE_QUERIES;
      ret = true;
    }

#endif
#if NX_SDK_VERSION_NUMBER >= 270
    else if(strcasecmp(str, "NX_SF_CLOTH_DRAIN") == 0)
    {
      v = NX_SF_CLOTH_DRAIN;
      ret = true;
    }
...
#endif
#if NX_SDK_VERSION_NUMBER >= 270
    else if(strcasecmp(str, "NX_SF_CLOTH_DISABLE_COLLISION") == 0)
    {
      v = NX_SF_CLOTH_DISABLE_COLLISION;
      ret = true;
    }

#endif
#if NX_SDK_VERSION_NUMBER >= 270
    else if(strcasecmp(str, "NX_SF_CLOTH_TWOWAY") == 0)
    {
      v = NX_SF_CLOTH_TWOWAY;
      ret = true;
    }

#endif
#if NX_USE_SOFTBODY_API
    else if(strcasecmp(str, "NX_SF_SOFTBODY_DRAIN") == 0)
    {
      v = NX_SF_SOFTBODY_DRAIN;
      ret = true;
    }

#endif
#if NX_USE_SOFTBODY_API
    else if(strcasecmp(str, "NX_SF_SOFTBODY_DISABLE_COLLISION") == 0)
    {
      v = NX_SF_SOFTBODY_DISABLE_COLLISION;
      ret = true;
    }

#endif
#if NX_USE_SOFTBODY_API
    else if(strcasecmp(str, "NX_SF_SOFTBODY_TWOWAY") == 0)
    {
      v = NX_SF_SOFTBODY_TWOWAY;
      ret = true;
    }
  ...
  bool         StringToEnum(const char *str, NxCapsuleShapeFlag &v)
  {
    ...
    else if(strcasecmp(str, "NX_SWEPT_SHAPE") == 0)
    {
      v = NX_SWEPT_SHAPE;
      ret = true;
    }
  ...
  const char * EnumToString(NxWheelShapeFlags v)
  {
    ...
    switch(v)
    {
      case NX_WF_WHEEL_AXIS_CONTACT_NORMAL:
        ret = "NX_WF_WHEEL_AXIS_CONTACT_NORMAL";
        break;
      case NX_WF_INPUT_LAT_SLIPVELOCITY:
        ret = "NX_WF_INPUT_LAT_SLIPVELOCITY";
        break;
      case NX_WF_INPUT_LNG_SLIPVELOCITY:
        ret = "NX_WF_INPUT_LNG_SLIPVELOCITY";
        break;
      case NX_WF_UNSCALED_SPRING_BEHAVIOR:
        ret = "NX_WF_UNSCALED_SPRING_BEHAVIOR";
        break;
      case NX_WF_AXLE_SPEED_OVERRIDE:
        ret = "NX_WF_AXLE_SPEED_OVERRIDE";
        break;
#if NX_SDK_VERSION_NUMBER >= 264
      case NX_WF_EMULATE_LEGACY_WHEEL:
        ret = "NX_WF_EMULATE_LEGACY_WHEEL";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 264
      case NX_WF_CLAMPED_FRICTION:
        ret = "NX_WF_CLAMPED_FRICTION";
        break;
#endif
      default:
        break;
  ...
  bool         StringToEnum(const char *str, NxWheelShapeFlags &v)
  {
    ...
    else if(strcasecmp(str, "NX_WF_WHEEL_AXIS_CONTACT_NORMAL") == 0)
    {
      v = NX_WF_WHEEL_AXIS_CONTACT_NORMAL;
      ret = true;
    }
    else if(strcasecmp(str, "NX_WF_INPUT_LAT_SLIPVELOCITY") == 0)
    {
      v = NX_WF_INPUT_LAT_SLIPVELOCITY;
      ret = true;
    }
    else if(strcasecmp(str, "NX_WF_INPUT_LNG_SLIPVELOCITY") == 0)
    {
      v = NX_WF_INPUT_LNG_SLIPVELOCITY;
      ret = true;
    }
    else if(strcasecmp(str, "NX_WF_UNSCALED_SPRING_BEHAVIOR") == 0)
    {
      v = NX_WF_UNSCALED_SPRING_BEHAVIOR;
      ret = true;
    }
    else if(strcasecmp(str, "NX_WF_AXLE_SPEED_OVERRIDE") == 0)
    {
      v = NX_WF_AXLE_SPEED_OVERRIDE;
      ret = true;
    }

#if NX_SDK_VERSION_NUMBER >= 264
    else if(strcasecmp(str, "NX_WF_EMULATE_LEGACY_WHEEL") == 0)
    {
      v = NX_WF_EMULATE_LEGACY_WHEEL;
      ret = true;
    }

#endif
#if NX_SDK_VERSION_NUMBER >= 264
    else if(strcasecmp(str, "NX_WF_CLAMPED_FRICTION") == 0)
    {
      v = NX_WF_CLAMPED_FRICTION;
      ret = true;
    }
  ...
  const char * EnumToString(NxMeshPagingMode v)
  {
    ...
    switch(v)
    {
      case NX_MESH_PAGING_MANUAL:
        ret = "NX_MESH_PAGING_MANUAL";
        break;
      case NX_MESH_PAGING_FALLBACK:
        ret = "NX_MESH_PAGING_FALLBACK";
        break;
      case NX_MESH_PAGING_AUTO:
        ret = "NX_MESH_PAGING_AUTO";
        break;
      default:
        break;
    }
  ...
  bool         StringToEnum(const char *str, NxMeshPagingMode &v)
  {
    ...
    if(str)
    {
      ...
      else if(strcasecmp(str, "NX_MESH_PAGING_MANUAL") == 0)
      {
        v = NX_MESH_PAGING_MANUAL;
        ret = true;
      }
      else if(strcasecmp(str, "NX_MESH_PAGING_FALLBACK") == 0)
      {
        v = NX_MESH_PAGING_FALLBACK;
        ret = true;
      }
      else if(strcasecmp(str, "NX_MESH_PAGING_AUTO") == 0)
      {
        v = NX_MESH_PAGING_AUTO;
        ret = true;
      }
    }
  ...
  const char * EnumToString(NxMeshShapeFlag v)
  {
    ...
    switch(v)
    {
      case NX_MESH_SMOOTH_SPHERE_COLLISIONS:
        ret = "NX_MESH_SMOOTH_SPHERE_COLLISIONS";
        break;
      case NX_MESH_DOUBLE_SIDED:
        ret = "NX_MESH_DOUBLE_SIDED";
        break;
      default:
        break;
    }
  ...
  bool         StringToEnum(const char *str, NxMeshShapeFlag &v)
  {
    ...
    else if(strcasecmp(str, "NX_MESH_SMOOTH_SPHERE_COLLISIONS") == 0)
    {
      v = NX_MESH_SMOOTH_SPHERE_COLLISIONS;
      ret = true;
    }
    else if(strcasecmp(str, "NX_MESH_DOUBLE_SIDED") == 0)
    {
      v = NX_MESH_DOUBLE_SIDED;
      ret = true;
    }
  ...
  bool         StringToEnum(const char *str, NxJointType &v)
  {
    ...
    if(str)
    {
      ...
      else if(strcasecmp(str, "NX_JOINT_PRISMATIC") == 0)
      {
        v = NX_JOINT_PRISMATIC;
        ret = true;
      }
      else if(strcasecmp(str, "NX_JOINT_REVOLUTE") == 0)
      {
        v = NX_JOINT_REVOLUTE;
        ret = true;
      }
      else if(strcasecmp(str, "NX_JOINT_CYLINDRICAL") == 0)
      {
        v = NX_JOINT_CYLINDRICAL;
        ret = true;
      }
      else if(strcasecmp(str, "NX_JOINT_SPHERICAL") == 0)
      {
        v = NX_JOINT_SPHERICAL;
        ret = true;
      }
      else if(strcasecmp(str, "NX_JOINT_POINT_ON_LINE") == 0)
      {
        v = NX_JOINT_POINT_ON_LINE;
        ret = true;
      }
      else if(strcasecmp(str, "NX_JOINT_POINT_IN_PLANE") == 0)
      {
        v = NX_JOINT_POINT_IN_PLANE;
        ret = true;
      }
      else if(strcasecmp(str, "NX_JOINT_DISTANCE") == 0)
      {
        v = NX_JOINT_DISTANCE;
        ret = true;
      }
      else if(strcasecmp(str, "NX_JOINT_PULLEY") == 0)
      {
        v = NX_JOINT_PULLEY;
        ret = true;
      }
      else if(strcasecmp(str, "NX_JOINT_FIXED") == 0)
      {
        v = NX_JOINT_FIXED;
        ret = true;
      }
      else if(strcasecmp(str, "NX_JOINT_D6") == 0)
      {
        v = NX_JOINT_D6;
        ret = true;
      }
  ...
  const char * EnumToString(NxJointFlag v)
  {
    ...
    switch(v)
    {
      case NX_JF_COLLISION_ENABLED:
        ret = "NX_JF_COLLISION_ENABLED";
        break;
      case NX_JF_VISUALIZATION:
        ret = "NX_JF_VISUALIZATION";
        break;
      default:
        break;
    }
  ...
  bool         StringToEnum(const char *str, NxJointFlag &v)
  {
    ...
    else if(strcasecmp(str, "NX_JF_COLLISION_ENABLED") == 0)
    {
      v = NX_JF_COLLISION_ENABLED;
      ret = true;
    }
    else if(strcasecmp(str, "NX_JF_VISUALIZATION") == 0)
    {
      v = NX_JF_VISUALIZATION;
      ret = true;
    }
  ...
  bool         StringToEnum(const char *str, NxD6JointMotion &v)
  {
    ...
    if(str)
    {
      ...
      else if(strcasecmp(str, "NX_D6JOINT_MOTION_LOCKED") == 0)
      {
        v = NX_D6JOINT_MOTION_LOCKED;
        ret = true;
      }
      else if(strcasecmp(str, "NX_D6JOINT_MOTION_LIMITED") == 0)
      {
        v = NX_D6JOINT_MOTION_LIMITED;
        ret = true;
      }
      else if(strcasecmp(str, "NX_D6JOINT_MOTION_FREE") == 0)
      {
        v = NX_D6JOINT_MOTION_FREE;
        ret = true;
      }
    }
  ...
  bool         StringToEnum(const char *str, NxD6JointDriveType &v)
  {
    ...
    else if(strcasecmp(str, "NX_D6JOINT_DRIVE_POSITION") == 0)
    {
      v = NX_D6JOINT_DRIVE_POSITION;
      ret = true;
    }
    else if(strcasecmp(str, "NX_D6JOINT_DRIVE_VELOCITY") == 0)
    {
      v = NX_D6JOINT_DRIVE_VELOCITY;
      ret = true;
    }
  ...
  const char * EnumToString(NxJointProjectionMode v)
  {
    ...
    switch(v)
    {
      ...
      case NX_JPM_POINT_MINDIST:
        ret = "NX_JPM_POINT_MINDIST";
        break;
#if NX_SDK_VERSION_NUMBER >= 260
      case NX_JPM_LINEAR_MINDIST:
        ret = "NX_JPM_LINEAR_MINDIST";
        break;
#endif
      default:
        break;
  ...
  bool         StringToEnum(const char *str, NxJointProjectionMode &v)
  {
    ...
    if(str)
    {
      ...
      else if(strcasecmp(str, "NX_JPM_NONE") == 0)
      {
        v = NX_JPM_NONE;
        ret = true;
      }
      else if(strcasecmp(str, "NX_JPM_POINT_MINDIST") == 0)
      {
        v = NX_JPM_POINT_MINDIST;
        ret = true;
      }

#if NX_SDK_VERSION_NUMBER >= 260
      else if(strcasecmp(str, "NX_JPM_LINEAR_MINDIST") == 0)
      {
        v = NX_JPM_LINEAR_MINDIST;
        ret = true;
      }
  ...
  const char * EnumToString(NxD6JointFlag v)
  {
    ...
    switch(v)
    {
      case NX_D6JOINT_SLERP_DRIVE:
        ret = "NX_D6JOINT_SLERP_DRIVE";
        break;
      case NX_D6JOINT_GEAR_ENABLED:
        ret = "NX_D6JOINT_GEAR_ENABLED";
        break;
      default:
        break;
    }
  ...
  bool         StringToEnum(const char *str, NxD6JointFlag &v)
  {
    ...
    else if(strcasecmp(str, "NX_D6JOINT_SLERP_DRIVE") == 0)
    {
      v = NX_D6JOINT_SLERP_DRIVE;
      ret = true;
    }
    else if(strcasecmp(str, "NX_D6JOINT_GEAR_ENABLED") == 0)
    {
      v = NX_D6JOINT_GEAR_ENABLED;
      ret = true;
    }
  ...
  const char * EnumToString(NxDistanceJointFlag v)
  {
    ...
    switch(v)
    {
      case NX_DJF_MAX_DISTANCE_ENABLED:
        ret = "NX_DJF_MAX_DISTANCE_ENABLED";
        break;
      case NX_DJF_MIN_DISTANCE_ENABLED:
        ret = "NX_DJF_MIN_DISTANCE_ENABLED";
        break;
      case NX_DJF_SPRING_ENABLED:
        ret = "NX_DJF_SPRING_ENABLED";
        break;
      default:
        break;
    }
  ...
  bool         StringToEnum(const char *str, NxDistanceJointFlag &v)
  {
    ...
    else if(strcasecmp(str, "NX_DJF_MAX_DISTANCE_ENABLED") == 0)
    {
      v = NX_DJF_MAX_DISTANCE_ENABLED;
      ret = true;
    }
    else if(strcasecmp(str, "NX_DJF_MIN_DISTANCE_ENABLED") == 0)
    {
      v = NX_DJF_MIN_DISTANCE_ENABLED;
      ret = true;
    }
    else if(strcasecmp(str, "NX_DJF_SPRING_ENABLED") == 0)
    {
      v = NX_DJF_SPRING_ENABLED;
      ret = true;
    }
  ...
  const char * EnumToString(NxRevoluteJointFlag v)
  {
    ...
    switch(v)
    {
      case NX_RJF_LIMIT_ENABLED:
        ret = "NX_RJF_LIMIT_ENABLED";
        break;
      case NX_RJF_MOTOR_ENABLED:
        ret = "NX_RJF_MOTOR_ENABLED";
        break;
      case NX_RJF_SPRING_ENABLED:
        ret = "NX_RJF_SPRING_ENABLED";
        break;
      default:
        break;
    }
  ...
  bool         StringToEnum(const char *str, NxRevoluteJointFlag &v)
  {
    ...
    else if(strcasecmp(str, "NX_RJF_LIMIT_ENABLED") == 0)
    {
      v = NX_RJF_LIMIT_ENABLED;
      ret = true;
    }
    else if(strcasecmp(str, "NX_RJF_MOTOR_ENABLED") == 0)
    {
      v = NX_RJF_MOTOR_ENABLED;
      ret = true;
    }
    else if(strcasecmp(str, "NX_RJF_SPRING_ENABLED") == 0)
    {
      v = NX_RJF_SPRING_ENABLED;
      ret = true;
    }
  ...
  const char * EnumToString(NxSphericalJointFlag v)
  {
    ...
    switch(v)
    {
      case NX_SJF_TWIST_LIMIT_ENABLED:
        ret = "NX_SJF_TWIST_LIMIT_ENABLED";
        break;
      case NX_SJF_SWING_LIMIT_ENABLED:
        ret = "NX_SJF_SWING_LIMIT_ENABLED";
        break;
      case NX_SJF_TWIST_SPRING_ENABLED:
        ret = "NX_SJF_TWIST_SPRING_ENABLED";
        break;
      case NX_SJF_SWING_SPRING_ENABLED:
        ret = "NX_SJF_SWING_SPRING_ENABLED";
        break;
      case NX_SJF_JOINT_SPRING_ENABLED:
        ret = "NX_SJF_JOINT_SPRING_ENABLED";
        break;
#if NX_SDK_VERSION_NUMBER >= 281
      case NX_SJF_PERPENDICULAR_DIR_CONSTRAINTS:
        ret = "NX_SJF_PERPENDICULAR_DIR_CONSTRAINTS";
        break;
#endif
      default:
        break;
  ...
  bool         StringToEnum(const char *str, NxSphericalJointFlag &v)
  {
    ...
    else if(strcasecmp(str, "NX_SJF_TWIST_LIMIT_ENABLED") == 0)
    {
      v = NX_SJF_TWIST_LIMIT_ENABLED;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SJF_SWING_LIMIT_ENABLED") == 0)
    {
      v = NX_SJF_SWING_LIMIT_ENABLED;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SJF_TWIST_SPRING_ENABLED") == 0)
    {
      v = NX_SJF_TWIST_SPRING_ENABLED;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SJF_SWING_SPRING_ENABLED") == 0)
    {
      v = NX_SJF_SWING_SPRING_ENABLED;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SJF_JOINT_SPRING_ENABLED") == 0)
    {
      v = NX_SJF_JOINT_SPRING_ENABLED;
      ret = true;
    }

#if NX_SDK_VERSION_NUMBER >= 281
    else if(strcasecmp(str, "NX_SJF_PERPENDICULAR_DIR_CONSTRAINTS") == 0)
    {
      v = NX_SJF_PERPENDICULAR_DIR_CONSTRAINTS;
      ret = true;
    }
  ...
  const char * EnumToString(NxPulleyJointFlag v)
  {
    ...
    switch(v)
    {
      case NX_PJF_IS_RIGID:
        ret = "NX_PJF_IS_RIGID";
        break;
      case NX_PJF_MOTOR_ENABLED:
        ret = "NX_PJF_MOTOR_ENABLED";
        break;
      default:
        break;
    }
  ...
  bool         StringToEnum(const char *str, NxPulleyJointFlag &v)
  {
    ...
    else if(strcasecmp(str, "NX_PJF_IS_RIGID") == 0)
    {
      v = NX_PJF_IS_RIGID;
      ret = true;
    }
    else if(strcasecmp(str, "NX_PJF_MOTOR_ENABLED") == 0)
    {
      v = NX_PJF_MOTOR_ENABLED;
      ret = true;
    }
  ...
  const char * EnumToString(NxContactPairFlag v)
  {
    ...
    switch(v)
    {
      ...
      case NX_NOTIFY_ON_START_TOUCH:
        ret = "NX_NOTIFY_ON_START_TOUCH";
        break;
      case NX_NOTIFY_ON_END_TOUCH:
        ret = "NX_NOTIFY_ON_END_TOUCH";
        break;
      case NX_NOTIFY_ON_TOUCH:
        ret = "NX_NOTIFY_ON_TOUCH";
        break;
      case NX_NOTIFY_ON_IMPACT:
        ret = "NX_NOTIFY_ON_IMPACT";
        break;
      case NX_NOTIFY_ON_ROLL:
        ret = "NX_NOTIFY_ON_ROLL";
        break;
      case NX_NOTIFY_ON_SLIDE:
        ret = "NX_NOTIFY_ON_SLIDE";
        break;
#if NX_SDK_VERSION_NUMBER >= 250
      case NX_NOTIFY_FORCES:
        ret = "NX_NOTIFY_FORCES";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 280
      case NX_NOTIFY_ON_START_TOUCH_FORCE_THRESHOLD:
        ret = "NX_NOTIFY_ON_START_TOUCH_FORCE_THRESHOLD";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 280
      case NX_NOTIFY_ON_END_TOUCH_FORCE_THRESHOLD:
        ret = "NX_NOTIFY_ON_END_TOUCH_FORCE_THRESHOLD";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 280
      case NX_NOTIFY_ON_TOUCH_FORCE_THRESHOLD:
        ret = "NX_NOTIFY_ON_TOUCH_FORCE_THRESHOLD";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 250
      case NX_NOTIFY_CONTACT_MODIFICATION:
        ret = "NX_NOTIFY_CONTACT_MODIFICATION";
        break;
#endif
      default:
        break;
  ...
  bool         StringToEnum(const char *str, NxContactPairFlag &v)
  {
    ...
    else if(strcasecmp(str, "NX_IGNORE_PAIR") == 0)
    {
      v = NX_IGNORE_PAIR;
      ret = true;
    }
    else if(strcasecmp(str, "NX_NOTIFY_ON_START_TOUCH") == 0)
    {
      v = NX_NOTIFY_ON_START_TOUCH;
      ret = true;
    }
    else if(strcasecmp(str, "NX_NOTIFY_ON_END_TOUCH") == 0)
    {
      v = NX_NOTIFY_ON_END_TOUCH;
      ret = true;
    }
    else if(strcasecmp(str, "NX_NOTIFY_ON_TOUCH") == 0)
    {
      v = NX_NOTIFY_ON_TOUCH;
      ret = true;
    }
    else if(strcasecmp(str, "NX_NOTIFY_ON_IMPACT") == 0)
    {
      v = NX_NOTIFY_ON_IMPACT;
      ret = true;
    }
    else if(strcasecmp(str, "NX_NOTIFY_ON_ROLL") == 0)
    {
      v = NX_NOTIFY_ON_ROLL;
      ret = true;
    }
    else if(strcasecmp(str, "NX_NOTIFY_ON_SLIDE") == 0)
    {
      v = NX_NOTIFY_ON_SLIDE;
      ret = true;
    }

#if NX_SDK_VERSION_NUMBER >= 250
    else if(strcasecmp(str, "NX_NOTIFY_FORCES") == 0)
    {
      v = NX_NOTIFY_FORCES;
      ret = true;
    }
...
#endif
#if NX_SDK_VERSION_NUMBER >= 280
    else if(strcasecmp(str, "NX_NOTIFY_ON_START_TOUCH_FORCE_THRESHOLD") == 0)
    {
      v = NX_NOTIFY_ON_START_TOUCH_FORCE_THRESHOLD;
      ret = true;
    }

#endif
#if NX_SDK_VERSION_NUMBER >= 280
    else if(strcasecmp(str, "NX_NOTIFY_ON_END_TOUCH_FORCE_THRESHOLD") == 0)
    {
      v = NX_NOTIFY_ON_END_TOUCH_FORCE_THRESHOLD;
      ret = true;
    }

#endif
#if NX_SDK_VERSION_NUMBER >= 280
    else if(strcasecmp(str, "NX_NOTIFY_ON_TOUCH_FORCE_THRESHOLD") == 0)
    {
      v = NX_NOTIFY_ON_TOUCH_FORCE_THRESHOLD;
      ret = true;
    }

#endif
#if NX_SDK_VERSION_NUMBER >= 250
    else if(strcasecmp(str, "NX_NOTIFY_CONTACT_MODIFICATION") == 0)
    {
      v = NX_NOTIFY_CONTACT_MODIFICATION;
      ret = true;
    }
  ...
  const char * EnumToString(NxFluidSimulationMethod v)
  {
    ...
    switch(v)
    {
      ...
      case NX_F_NO_PARTICLE_INTERACTION:
        ret = "NX_F_NO_PARTICLE_INTERACTION";
        break;
  ...
  bool         StringToEnum(const char *str, NxFluidSimulationMethod &v)
  {
    ...
    else if(strcasecmp(str, "NX_F_SPH") == 0)
    {
      v = NX_F_SPH;
      ret = true;
    }
    else if(strcasecmp(str, "NX_F_NO_PARTICLE_INTERACTION") == 0)
    {
      v = NX_F_NO_PARTICLE_INTERACTION;
      ret = true;
    }
    else if(strcasecmp(str, "NX_F_MIXED_MODE") == 0)
    {
      v = NX_F_MIXED_MODE;
      ret = true;
    }
  ...
  bool         StringToEnum(const char *str, NxFluidCollisionMethod &v)
  {
    ...
    else if(strcasecmp(str, "NX_F_STATIC") == 0)
    {
      v = NX_F_STATIC;
      ret = true;
    }
    else if(strcasecmp(str, "NX_F_DYNAMIC") == 0)
    {
      v = NX_F_DYNAMIC;
      ret = true;
    }
  ...
  const char * EnumToString(NxFluidFlag v)
  {
    ...
    switch(v)
    {
      case NX_FF_VISUALIZATION:
        ret = "NX_FF_VISUALIZATION";
        break;
      case NX_FF_DISABLE_GRAVITY:
        ret = "NX_FF_DISABLE_GRAVITY";
        break;
#if NX_SDK_VERSION_NUMBER >= 250
      case NX_FF_COLLISION_TWOWAY:
        ret = "NX_FF_COLLISION_TWOWAY";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 250
      case NX_FF_ENABLED:
...
#endif
#if NX_SDK_VERSION_NUMBER >= 270
      case NX_FF_PRIORITY_MODE:
        ret = "NX_FF_PRIORITY_MODE";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 280
      case NX_FF_PROJECT_TO_PLANE:
        ret = "NX_FF_PROJECT_TO_PLANE";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 280
      case NX_FF_FORCE_STRICT_COOKING_FORMAT:
        ret = "NX_FF_FORCE_STRICT_COOKING_FORMAT";
        break;
#endif
      default:
        break;
  ...
  bool         StringToEnum(const char *str, NxFluidFlag &v)
  {
    ...
    else if(strcasecmp(str, "NX_FF_VISUALIZATION") == 0)
    {
      v = NX_FF_VISUALIZATION;
      ret = true;
    }
    else if(strcasecmp(str, "NX_FF_DISABLE_GRAVITY") == 0)
    {
      v = NX_FF_DISABLE_GRAVITY;
      ret = true;
    }

#if NX_SDK_VERSION_NUMBER >= 250
    else if(strcasecmp(str, "NX_FF_COLLISION_TWOWAY") == 0)
    {
      v = NX_FF_COLLISION_TWOWAY;
      ret = true;
    }

#endif
#if NX_SDK_VERSION_NUMBER >= 250
    else if(strcasecmp(str, "NX_FF_ENABLED") == 0)
    {
      v = NX_FF_ENABLED;
      ret = true;
    }
...
#endif
#if NX_SDK_VERSION_NUMBER >= 250
    else if(strcasecmp(str, "NX_FF_HARDWARE") == 0)
    {
      v = NX_FF_HARDWARE;
      ret = true;
    }
...
#endif
#if NX_SDK_VERSION_NUMBER >= 270
    else if(strcasecmp(str, "NX_FF_PRIORITY_MODE") == 0)
    {
      v = NX_FF_PRIORITY_MODE;
      ret = true;
    }

#endif
#if NX_SDK_VERSION_NUMBER >= 280
    else if(strcasecmp(str, "NX_FF_PROJECT_TO_PLANE") == 0)
    {
      v = NX_FF_PROJECT_TO_PLANE;
      ret = true;
    }

#endif
#if NX_SDK_VERSION_NUMBER >= 280
    else if(strcasecmp(str, "NX_FF_FORCE_STRICT_COOKING_FORMAT") == 0)
    {
      v = NX_FF_FORCE_STRICT_COOKING_FORMAT;
      ret = true;
    }
  ...
  const char * EnumToString(NxEmitterType v)
  {
    ...
    switch(v)
    {
      case NX_FE_CONSTANT_PRESSURE:
        ret = "NX_FE_CONSTANT_PRESSURE";
        break;
      case NX_FE_CONSTANT_FLOW_RATE:
        ret = "NX_FE_CONSTANT_FLOW_RATE";
        break;
      default:
        break;
    }
  ...
  bool         StringToEnum(const char *str, NxEmitterType &v)
  {
    ...
    else if(strcasecmp(str, "NX_FE_CONSTANT_PRESSURE") == 0)
    {
      v = NX_FE_CONSTANT_PRESSURE;
      ret = true;
    }
    else if(strcasecmp(str, "NX_FE_CONSTANT_FLOW_RATE") == 0)
    {
      v = NX_FE_CONSTANT_FLOW_RATE;
      ret = true;
    }
  ...
  const char * EnumToString(NxEmitterShape v)
  {
    ...
    switch(v)
    {
      case NX_FE_RECTANGULAR:
        ret = "NX_FE_RECTANGULAR";
        break;
      case NX_FE_ELLIPSE:
        ret = "NX_FE_ELLIPSE";
        break;
  ...
  bool         StringToEnum(const char *str, NxEmitterShape &v)
  {
    ...
    else if(strcasecmp(str, "NX_FE_RECTANGULAR") == 0)
    {
      v = NX_FE_RECTANGULAR;
      ret = true;
    }
    else if(strcasecmp(str, "NX_FE_ELLIPSE") == 0)
    {
      v = NX_FE_ELLIPSE;
      ret = true;
    }
  ...
  const char * EnumToString(NxFluidEmitterFlag v)
  {
    ...
    switch(v)
    {
      case NX_FEF_VISUALIZATION:
        ret = "NX_FEF_VISUALIZATION";
        break;
#if NX_SDK_VERSION_NUMBER < 250
      case NX_FEF_BROKEN_ACTOR_REF:
        ret = "NX_FEF_BROKEN_ACTOR_REF";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 250
      case NX_FEF_DUMMY1:
...
#endif
#if NX_SDK_VERSION_NUMBER < 260
      case NX_FEF_FORCE_ON_ACTOR:
        ret = "NX_FEF_FORCE_ON_ACTOR";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 260
      case NX_FEF_FORCE_ON_BODY:
        ret = "NX_FEF_FORCE_ON_BODY";
        break;
#endif
#if NX_SDK_VERSION_NUMBER < 260
      case NX_FEF_ADD_ACTOR_VELOCITY:
        ret = "NX_FEF_ADD_ACTOR_VELOCITY";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 260
      case NX_FEF_ADD_BODY_VELOCITY:
        ret = "NX_FEF_ADD_BODY_VELOCITY";
        break;
#endif
      case NX_FEF_ENABLED:
        ret = "NX_FEF_ENABLED";
  ...
  bool         StringToEnum(const char *str, NxFluidEmitterFlag &v)
  {
    ...
    else if(strcasecmp(str, "NX_FEF_VISUALIZATION") == 0)
    {
      v = NX_FEF_VISUALIZATION;
      ret = true;
    }

#if NX_SDK_VERSION_NUMBER < 250
    else if(strcasecmp(str, "NX_FEF_BROKEN_ACTOR_REF") == 0)
    {
      v = NX_FEF_BROKEN_ACTOR_REF;
      ret = true;
    }

#endif
#if NX_SDK_VERSION_NUMBER >= 250
    else if(strcasecmp(str, "NX_FEF_DUMMY1") == 0)
    {
      v = NX_FEF_DUMMY1;
      ret = true;
    }
...
#endif
#if NX_SDK_VERSION_NUMBER < 260
    else if(strcasecmp(str, "NX_FEF_FORCE_ON_ACTOR") == 0)
    {
      v = NX_FEF_FORCE_ON_ACTOR;
      ret = true;
    }

#endif
#if NX_SDK_VERSION_NUMBER >= 260
    else if(strcasecmp(str, "NX_FEF_FORCE_ON_BODY") == 0)
    {
      v = NX_FEF_FORCE_ON_BODY;
      ret = true;
    }

#endif
#if NX_SDK_VERSION_NUMBER < 260
    else if(strcasecmp(str, "NX_FEF_ADD_ACTOR_VELOCITY") == 0)
    {
      v = NX_FEF_ADD_ACTOR_VELOCITY;
      ret = true;
    }

#endif
#if NX_SDK_VERSION_NUMBER >= 260
    else if(strcasecmp(str, "NX_FEF_ADD_BODY_VELOCITY") == 0)
    {
      v = NX_FEF_ADD_BODY_VELOCITY;
      ret = true;
    }

#endif
    else if(strcasecmp(str, "NX_FEF_ENABLED") == 0)
    {
      v = NX_FEF_ENABLED;
      ret = true;
    }
  ...
  const char * EnumToString(NxClothFlag v)
  {
    ...
    switch(v)
    {
      case NX_CLF_PRESSURE:
        ret = "NX_CLF_PRESSURE";
        break;
      case NX_CLF_STATIC:
        ret = "NX_CLF_STATIC";
        break;
      case NX_CLF_DISABLE_COLLISION:
        ret = "NX_CLF_DISABLE_COLLISION";
        break;
      case NX_CLF_SELFCOLLISION:
        ret = "NX_CLF_SELFCOLLISION";
        break;
      case NX_CLF_VISUALIZATION:
        ret = "NX_CLF_VISUALIZATION";
        break;
      case NX_CLF_GRAVITY:
        ret = "NX_CLF_GRAVITY";
        break;
      case NX_CLF_BENDING:
        ret = "NX_CLF_BENDING";
        break;
      case NX_CLF_BENDING_ORTHO:
        ret = "NX_CLF_BENDING_ORTHO";
        break;
      case NX_CLF_DAMPING:
        ret = "NX_CLF_DAMPING";
        break;
      case NX_CLF_COLLISION_TWOWAY:
        ret = "NX_CLF_COLLISION_TWOWAY";
        break;
      case NX_CLF_DUMMY1:
        ret = "NX_CLF_DUMMY1";
        break;
      case NX_CLF_TRIANGLE_COLLISION:
        ret = "NX_CLF_TRIANGLE_COLLISION";
        break;
      case NX_CLF_TEARABLE:
        ret = "NX_CLF_TEARABLE";
        break;
      case NX_CLF_HARDWARE:
        ret = "NX_CLF_HARDWARE";
        break;
#if NX_SDK_VERSION_NUMBER >= 250
      case NX_CLF_COMDAMPING:
        ret = "NX_CLF_COMDAMPING";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 270
      case NX_CLF_VALIDBOUNDS:
        ret = "NX_CLF_VALIDBOUNDS";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 270
      case NX_CLF_FLUID_COLLISION:
        ret = "NX_CLF_FLUID_COLLISION";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 280
      case NX_CLF_DISABLE_DYNAMIC_CCD:
        ret = "NX_CLF_DISABLE_DYNAMIC_CCD";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 280
      case NX_CLF_ADHERE:
...
#endif
#if NX_SDK_VERSION_NUMBER >= 283
      case NX_CLF_HARD_STRETCH_LIMITATION:
        ret = "NX_CLF_HARD_STRETCH_LIMITATION";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 283
      case NX_CLF_UNTANGLING:
        ret = "NX_CLF_UNTANGLING";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 283
      case NX_CLF_INTER_COLLISION:
        ret = "NX_CLF_INTER_COLLISION";
        break;
#endif
      default:
        break;
  ...
  bool         StringToEnum(const char *str, NxClothFlag &v)
  {
    ...
    else if(strcasecmp(str, "NX_CLF_PRESSURE") == 0)
    {
      v = NX_CLF_PRESSURE;
      ret = true;
    }
    else if(strcasecmp(str, "NX_CLF_STATIC") == 0)
    {
      v = NX_CLF_STATIC;
      ret = true;
    }
    else if(strcasecmp(str, "NX_CLF_DISABLE_COLLISION") == 0)
    {
      v = NX_CLF_DISABLE_COLLISION;
      ret = true;
    }
    else if(strcasecmp(str, "NX_CLF_SELFCOLLISION") == 0)
    {
      v = NX_CLF_SELFCOLLISION;
      ret = true;
    }
    else if(strcasecmp(str, "NX_CLF_VISUALIZATION") == 0)
    {
      v = NX_CLF_VISUALIZATION;
      ret = true;
    }
    else if(strcasecmp(str, "NX_CLF_GRAVITY") == 0)
    {
      v = NX_CLF_GRAVITY;
      ret = true;
    }
    else if(strcasecmp(str, "NX_CLF_BENDING") == 0)
    {
      v = NX_CLF_BENDING;
      ret = true;
    }
    else if(strcasecmp(str, "NX_CLF_BENDING_ORTHO") == 0)
    {
      v = NX_CLF_BENDING_ORTHO;
      ret = true;
    }
    else if(strcasecmp(str, "NX_CLF_DAMPING") == 0)
    {
      v = NX_CLF_DAMPING;
      ret = true;
    }
    else if(strcasecmp(str, "NX_CLF_COLLISION_TWOWAY") == 0)
    {
      v = NX_CLF_COLLISION_TWOWAY;
      ret = true;
    }
    else if(strcasecmp(str, "NX_CLF_DUMMY1") == 0)
    {
      v = NX_CLF_DUMMY1;
      ret = true;
    }
    else if(strcasecmp(str, "NX_CLF_TRIANGLE_COLLISION") == 0)
    {
      v = NX_CLF_TRIANGLE_COLLISION;
      ret = true;
    }
    else if(strcasecmp(str, "NX_CLF_TEARABLE") == 0)
    {
      v = NX_CLF_TEARABLE;
      ret = true;
    }
    else if(strcasecmp(str, "NX_CLF_HARDWARE") == 0)
    {
      v = NX_CLF_HARDWARE;
      ret = true;
    }
...
#if NX_SDK_VERSION_NUMBER >= 250
    else if(strcasecmp(str, "NX_CLF_COMDAMPING") == 0)
    {
      v = NX_CLF_COMDAMPING;
      ret = true;
    }
...
#endif
#if NX_SDK_VERSION_NUMBER >= 270
    else if(strcasecmp(str, "NX_CLF_VALIDBOUNDS") == 0)
    {
      v = NX_CLF_VALIDBOUNDS;
      ret = true;
    }

#endif
#if NX_SDK_VERSION_NUMBER >= 270
    else if(strcasecmp(str, "NX_CLF_FLUID_COLLISION") == 0)
    {
      v = NX_CLF_FLUID_COLLISION;
      ret = true;
    }

#endif
#if NX_SDK_VERSION_NUMBER >= 280
    else if(strcasecmp(str, "NX_CLF_DISABLE_DYNAMIC_CCD") == 0)
    {
      v = NX_CLF_DISABLE_DYNAMIC_CCD;
      ret = true;
    }

#endif
#if NX_SDK_VERSION_NUMBER >= 280
    else if(strcasecmp(str, "NX_CLF_ADHERE") == 0)
    {
      v = NX_CLF_ADHERE;
      ret = true;
    }
...
#endif
#if NX_SDK_VERSION_NUMBER >= 283
    else if(strcasecmp(str, "NX_CLF_DUMMY19") == 0)
    {
      v = NX_CLF_DUMMY19;
      ret = true;
    }
...
#endif
#if NX_SDK_VERSION_NUMBER >= 283
    else if(strcasecmp(str, "NX_CLF_HARD_STRETCH_LIMITATION") == 0)
    {
      v = NX_CLF_HARD_STRETCH_LIMITATION;
      ret = true;
    }

#endif
#if NX_SDK_VERSION_NUMBER >= 283
    else if(strcasecmp(str, "NX_CLF_UNTANGLING") == 0)
    {
      v = NX_CLF_UNTANGLING;
      ret = true;
    }
...
#endif
#if NX_SDK_VERSION_NUMBER >= 283
    else if(strcasecmp(str, "NX_CLF_INTER_COLLISION") == 0)
    {
      v = NX_CLF_INTER_COLLISION;
      ret = true;
    }
  ...
  const char * EnumToString(NxForceFieldCoordinates v)
  {
    ...
    switch(v)
    {
      case NX_FFC_CARTESIAN:
        ret = "NX_FFC_CARTESIAN";
        break;
      case NX_FFC_SPHERICAL:
        ret = "NX_FFC_SPHERICAL";
        break;
      case NX_FFC_CYLINDRICAL:
        ret = "NX_FFC_CYLINDRICAL";
        break;
  ...
  bool         StringToEnum(const char *str, NxForceFieldCoordinates &v)
  {
    ...
    if(str)
    {
      ...
      else if(strcasecmp(str, "NX_FFC_CARTESIAN") == 0)
      {
        v = NX_FFC_CARTESIAN;
        ret = true;
      }
      else if(strcasecmp(str, "NX_FFC_SPHERICAL") == 0)
      {
        v = NX_FFC_SPHERICAL;
        ret = true;
      }
      else if(strcasecmp(str, "NX_FFC_CYLINDRICAL") == 0)
      {
        v = NX_FFC_CYLINDRICAL;
        ret = true;
      }
      else if(strcasecmp(str, "NX_FFC_TOROIDAL") == 0)
      {
        v = NX_FFC_TOROIDAL;
        ret = true;
      }
  ...
  const char * EnumToString(NxForceFieldType v)
  {
    ...
    {
#if NX_SDK_VERSION_NUMBER >= 273 && NX_SDK_VERSION_NUMBER != 274
      case NX_FF_TYPE_DUMMY_0:
        ret = "NX_FF_TYPE_DUMMY_0";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 273 && NX_SDK_VERSION_NUMBER != 274
      case NX_FF_TYPE_DUMMY_1:
        ret = "NX_FF_TYPE_DUMMY_1";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 280
      case NX_FF_TYPE_GRAVITATIONAL:
        ret = "NX_FF_TYPE_GRAVITATIONAL";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 280
      case NX_FF_TYPE_OTHER:
        ret = "NX_FF_TYPE_OTHER";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 280
      case NX_FF_TYPE_NO_INTERACTION:
        ret = "NX_FF_TYPE_NO_INTERACTION";
        break;
#endif
      default:
        break;
...
#if NX_SDK_VERSION_NUMBER >= 273 && NX_SDK_VERSION_NUMBER != 274
      else if(strcasecmp(str, "NX_FF_TYPE_DUMMY_0") == 0)
      {
        v = NX_FF_TYPE_DUMMY_0;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER >= 273 && NX_SDK_VERSION_NUMBER != 274
      else if(strcasecmp(str, "NX_FF_TYPE_DUMMY_1") == 0)
      {
        v = NX_FF_TYPE_DUMMY_1;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER >= 280
      else if(strcasecmp(str, "NX_FF_TYPE_GRAVITATIONAL") == 0)
      {
        v = NX_FF_TYPE_GRAVITATIONAL;
        ret = true;
      }

#endif
#if NX_SDK_VERSION_NUMBER >= 280
      else if(strcasecmp(str, "NX_FF_TYPE_OTHER") == 0)
      {
        v = NX_FF_TYPE_OTHER;
        ret = true;
      }
...
#endif
#if NX_SDK_VERSION_NUMBER >= 280
      else if(strcasecmp(str, "NX_FF_TYPE_NO_INTERACTION") == 0)
      {
        v = NX_FF_TYPE_NO_INTERACTION;
        ret = true;
      }
...
#endif
#if NX_SDK_VERSION_NUMBER >= 280
      case NX_FFF_VOLUMETRIC_SCALING_FLUID:
        ret = "NX_FFF_VOLUMETRIC_SCALING_FLUID";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 280
      case NX_FFF_VOLUMETRIC_SCALING_CLOTH:
        ret = "NX_FFF_VOLUMETRIC_SCALING_CLOTH";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 280
      case NX_FFF_VOLUMETRIC_SCALING_SOFTBODY:
        ret = "NX_FFF_VOLUMETRIC_SCALING_SOFTBODY";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 280
      case NX_FFF_VOLUMETRIC_SCALING_RIGIDBODY:
        ret = "NX_FFF_VOLUMETRIC_SCALING_RIGIDBODY";
        break;
#endif
      default:
        break;
...
#if NX_SDK_VERSION_NUMBER >= 272
    else if(strcasecmp(str, "NX_FFF_DUMMY_0") == 0)
    {
      v = NX_FFF_DUMMY_0;
      ret = true;
    }
...
#endif
#if NX_SDK_VERSION_NUMBER >= 272
    else if(strcasecmp(str, "NX_FFF_DUMMY_1") == 0)
    {
      v = NX_FFF_DUMMY_1;
      ret = true;
    }
...
#endif
#if NX_SDK_VERSION_NUMBER >= 272
    else if(strcasecmp(str, "NX_FFF_DUMMY_2") == 0)
    {
      v = NX_FFF_DUMMY_2;
      ret = true;
    }
...
#endif
#if NX_SDK_VERSION_NUMBER >= 272
    else if(strcasecmp(str, "NX_FFF_DUMMY_3") == 0)
    {
      v = NX_FFF_DUMMY_3;
      ret = true;
    }
...
#endif
#if NX_SDK_VERSION_NUMBER >= 272
    else if(strcasecmp(str, "NX_FFF_DUMMY_4") == 0)
    {
      v = NX_FFF_DUMMY_4;
      ret = true;
    }
...
#endif
#if NX_SDK_VERSION_NUMBER >= 280
    else if(strcasecmp(str, "NX_FFF_VOLUMETRIC_SCALING_FLUID") == 0)
    {
      v = NX_FFF_VOLUMETRIC_SCALING_FLUID;
      ret = true;
    }

#endif
#if NX_SDK_VERSION_NUMBER >= 280
    else if(strcasecmp(str, "NX_FFF_VOLUMETRIC_SCALING_CLOTH") == 0)
    {
      v = NX_FFF_VOLUMETRIC_SCALING_CLOTH;
      ret = true;
    }

#endif
#if NX_SDK_VERSION_NUMBER >= 280
    else if(strcasecmp(str, "NX_FFF_VOLUMETRIC_SCALING_SOFTBODY") == 0)
    {
      v = NX_FFF_VOLUMETRIC_SCALING_SOFTBODY;
      ret = true;
    }

#endif
#if NX_SDK_VERSION_NUMBER >= 280
    else if(strcasecmp(str, "NX_FFF_VOLUMETRIC_SCALING_RIGIDBODY") == 0)
    {
      v = NX_FFF_VOLUMETRIC_SCALING_RIGIDBODY;
      ret = true;
    }
  ...
  const char * EnumToString(NxForceFieldShapeGroupFlags v)
  {
    ...
    switch(v)
    {
      case NX_FFSG_EXCLUDE_GROUP:
        ret = "NX_FFSG_EXCLUDE_GROUP";
        break;
      default:
        break;
    }
  ...
  bool         StringToEnum(const char *str, NxForceFieldShapeGroupFlags &v)
  {
    ...
    else if(strcasecmp(str, "NX_FFSG_EXCLUDE_GROUP") == 0)
    {
      v = NX_FFSG_EXCLUDE_GROUP;
      ret = true;
    }
  ...
  const char * EnumToString(NxSoftBodyMeshFlags v)
  {
    ...
    switch(v)
    {
      case NX_SOFTBODY_MESH_DUMMY:
        ret = "NX_SOFTBODY_MESH_DUMMY";
        break;
      case NX_SOFTBODY_MESH_16_BIT_INDICES:
        ret = "NX_SOFTBODY_MESH_16_BIT_INDICES";
        break;
      case NX_SOFTBODY_MESH_TEARABLE:
        ret = "NX_SOFTBODY_MESH_TEARABLE";
        break;
      default:
        break;
    }
  ...
  bool         StringToEnum(const char *str, NxSoftBodyMeshFlags &v)
  {
    ...
    else if(strcasecmp(str, "NX_SOFTBODY_MESH_DUMMY") == 0)
    {
      v = NX_SOFTBODY_MESH_DUMMY;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SOFTBODY_MESH_16_BIT_INDICES") == 0)
    {
      v = NX_SOFTBODY_MESH_16_BIT_INDICES;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SOFTBODY_MESH_TEARABLE") == 0)
    {
      v = NX_SOFTBODY_MESH_TEARABLE;
      ret = true;
    }
  ...
  const char * EnumToString(NxSoftBodyVertexFlags v)
  {
    ...
    switch(v)
    {
      case NX_SOFTBODY_VERTEX_DUMMY0:
        ret = "NX_SOFTBODY_VERTEX_DUMMY0";
        break;
      case NX_SOFTBODY_VERTEX_DUMMY1:
        ret = "NX_SOFTBODY_VERTEX_DUMMY1";
        break;
      case NX_SOFTBODY_VERTEX_DUMMY2:
        ret = "NX_SOFTBODY_VERTEX_DUMMY2";
        break;
      case NX_SOFTBODY_VERTEX_DUMMY3:
        ret = "NX_SOFTBODY_VERTEX_DUMMY3";
        break;
      case NX_SOFTBODY_VERTEX_DUMMY4:
        ret = "NX_SOFTBODY_VERTEX_DUMMY4";
        break;
      case NX_SOFTBODY_VERTEX_DUMMY5:
        ret = "NX_SOFTBODY_VERTEX_DUMMY5";
        break;
      case NX_SOFTBODY_VERTEX_DUMMY6:
        ret = "NX_SOFTBODY_VERTEX_DUMMY6";
        break;
      case NX_SOFTBODY_VERTEX_TEARABLE:
        ret = "NX_SOFTBODY_VERTEX_TEARABLE";
        break;
      case NX_SOFTBODY_VERTEX_DUMMY8:
        ret = "NX_SOFTBODY_VERTEX_DUMMY8";
        break;
      case NX_SOFTBODY_VERTEX_DUMMY9:
        ret = "NX_SOFTBODY_VERTEX_DUMMY9";
        break;
      case NX_SOFTBODY_VERTEX_DUMMY10:
        ret = "NX_SOFTBODY_VERTEX_DUMMY10";
        break;
      case NX_SOFTBODY_VERTEX_DUMMY11:
        ret = "NX_SOFTBODY_VERTEX_DUMMY11";
        break;
      case NX_SOFTBODY_VERTEX_DUMMY12:
        ret = "NX_SOFTBODY_VERTEX_DUMMY12";
        break;
#if NX_SDK_VERSION_NUMBER >= 283
      case NX_SOFTBODY_VERTEX_SECONDARY:
        ret = "NX_SOFTBODY_VERTEX_SECONDARY";
        break;
#endif
      default:
        break;
  ...
  bool         StringToEnum(const char *str, NxSoftBodyVertexFlags &v)
  {
    ...
    else if(strcasecmp(str, "NX_SOFTBODY_VERTEX_DUMMY0") == 0)
    {
      v = NX_SOFTBODY_VERTEX_DUMMY0;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SOFTBODY_VERTEX_DUMMY1") == 0)
    {
      v = NX_SOFTBODY_VERTEX_DUMMY1;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SOFTBODY_VERTEX_DUMMY2") == 0)
    {
      v = NX_SOFTBODY_VERTEX_DUMMY2;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SOFTBODY_VERTEX_DUMMY3") == 0)
    {
      v = NX_SOFTBODY_VERTEX_DUMMY3;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SOFTBODY_VERTEX_DUMMY4") == 0)
    {
      v = NX_SOFTBODY_VERTEX_DUMMY4;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SOFTBODY_VERTEX_DUMMY5") == 0)
    {
      v = NX_SOFTBODY_VERTEX_DUMMY5;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SOFTBODY_VERTEX_DUMMY6") == 0)
    {
      v = NX_SOFTBODY_VERTEX_DUMMY6;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SOFTBODY_VERTEX_TEARABLE") == 0)
    {
      v = NX_SOFTBODY_VERTEX_TEARABLE;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SOFTBODY_VERTEX_DUMMY8") == 0)
    {
      v = NX_SOFTBODY_VERTEX_DUMMY8;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SOFTBODY_VERTEX_DUMMY9") == 0)
    {
      v = NX_SOFTBODY_VERTEX_DUMMY9;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SOFTBODY_VERTEX_DUMMY10") == 0)
    {
      v = NX_SOFTBODY_VERTEX_DUMMY10;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SOFTBODY_VERTEX_DUMMY11") == 0)
    {
      v = NX_SOFTBODY_VERTEX_DUMMY11;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SOFTBODY_VERTEX_DUMMY12") == 0)
    {
      v = NX_SOFTBODY_VERTEX_DUMMY12;
      ret = true;
    }

#if NX_SDK_VERSION_NUMBER >= 283
    else if(strcasecmp(str, "NX_SOFTBODY_VERTEX_SECONDARY") == 0)
    {
      v = NX_SOFTBODY_VERTEX_SECONDARY;
      ret = true;
    }
  ...
  const char * EnumToString(NxSoftBodyFlag v)
  {
    ...
    switch(v)
    {
      ...
      case NX_SBF_STATIC:
        ret = "NX_SBF_STATIC";
        break;
      case NX_SBF_DISABLE_COLLISION:
        ret = "NX_SBF_DISABLE_COLLISION";
        break;
      case NX_SBF_SELFCOLLISION:
        ret = "NX_SBF_SELFCOLLISION";
        break;
      case NX_SBF_VISUALIZATION:
        ret = "NX_SBF_VISUALIZATION";
        break;
      case NX_SBF_GRAVITY:
        ret = "NX_SBF_GRAVITY";
        break;
      case NX_SBF_VOLUME_CONSERVATION:
        ret = "NX_SBF_VOLUME_CONSERVATION";
        break;
      case NX_SBF_DAMPING:
        ret = "NX_SBF_DAMPING";
        break;
      case NX_SBF_COLLISION_TWOWAY:
        ret = "NX_SBF_COLLISION_TWOWAY";
        break;
      case NX_SBF_TEARABLE:
        ret = "NX_SBF_TEARABLE";
        break;
      case NX_SBF_HARDWARE:
        ret = "NX_SBF_HARDWARE";
        break;
      case NX_SBF_COMDAMPING:
        ret = "NX_SBF_COMDAMPING";
        break;
      case NX_SBF_VALIDBOUNDS:
        ret = "NX_SBF_VALIDBOUNDS";
        break;
      case NX_SBF_FLUID_COLLISION:
        ret = "NX_SBF_FLUID_COLLISION";
        break;
#if NX_SDK_VERSION_NUMBER >= 280
      case NX_SBF_DISABLE_DYNAMIC_CCD:
        ret = "NX_SBF_DISABLE_DYNAMIC_CCD";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 280
      case NX_SBF_ADHERE:
...
#endif
#if NX_SDK_VERSION_NUMBER >= 283
      case NX_SBF_HARD_STRETCH_LIMITATION:
        ret = "NX_SBF_HARD_STRETCH_LIMITATION";
        break;
#endif
#if NX_SDK_VERSION_NUMBER >= 283
      case NX_SBF_INTER_COLLISION:
        ret = "NX_SBF_INTER_COLLISION";
        break;
#endif
      default:
        break;
  ...
  bool         StringToEnum(const char *str, NxSoftBodyFlag &v)
  {
    ...
    else if(strcasecmp(str, "NX_SBF_DUMMY0") == 0)
    {
      v = NX_SBF_DUMMY0;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SBF_STATIC") == 0)
    {
      v = NX_SBF_STATIC;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SBF_DISABLE_COLLISION") == 0)
    {
      v = NX_SBF_DISABLE_COLLISION;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SBF_SELFCOLLISION") == 0)
    {
      v = NX_SBF_SELFCOLLISION;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SBF_VISUALIZATION") == 0)
    {
      v = NX_SBF_VISUALIZATION;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SBF_GRAVITY") == 0)
    {
      v = NX_SBF_GRAVITY;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SBF_VOLUME_CONSERVATION") == 0)
    {
      v = NX_SBF_VOLUME_CONSERVATION;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SBF_DAMPING") == 0)
    {
      v = NX_SBF_DAMPING;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SBF_COLLISION_TWOWAY") == 0)
    {
      v = NX_SBF_COLLISION_TWOWAY;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SBF_TEARABLE") == 0)
    {
      v = NX_SBF_TEARABLE;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SBF_HARDWARE") == 0)
    {
      v = NX_SBF_HARDWARE;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SBF_COMDAMPING") == 0)
    {
      v = NX_SBF_COMDAMPING;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SBF_VALIDBOUNDS") == 0)
    {
      v = NX_SBF_VALIDBOUNDS;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SBF_FLUID_COLLISION") == 0)
    {
      v = NX_SBF_FLUID_COLLISION;
      ret = true;
    }

#if NX_SDK_VERSION_NUMBER >= 280
    else if(strcasecmp(str, "NX_SBF_DISABLE_DYNAMIC_CCD") == 0)
    {
      v = NX_SBF_DISABLE_DYNAMIC_CCD;
      ret = true;
    }

#endif
#if NX_SDK_VERSION_NUMBER >= 280
    else if(strcasecmp(str, "NX_SBF_ADHERE") == 0)
    {
      v = NX_SBF_ADHERE;
      ret = true;
    }
...
#endif
#if NX_SDK_VERSION_NUMBER >= 283
    else if(strcasecmp(str, "NX_SBF_DUMMY16") == 0)
    {
      v = NX_SBF_DUMMY16;
      ret = true;
    }
...
#endif
#if NX_SDK_VERSION_NUMBER >= 283
    else if(strcasecmp(str, "NX_SBF_DUMMY17") == 0)
    {
      v = NX_SBF_DUMMY17;
      ret = true;
    }
...
#endif
#if NX_SDK_VERSION_NUMBER >= 283
    else if(strcasecmp(str, "NX_SBF_DUMMY18") == 0)
    {
      v = NX_SBF_DUMMY18;
      ret = true;
    }
...
#endif
#if NX_SDK_VERSION_NUMBER >= 283
    else if(strcasecmp(str, "NX_SBF_DUMMY19") == 0)
    {
      v = NX_SBF_DUMMY19;
      ret = true;
    }
...
#endif
#if NX_SDK_VERSION_NUMBER >= 283
    else if(strcasecmp(str, "NX_SBF_HARD_STRETCH_LIMITATION") == 0)
    {
      v = NX_SBF_HARD_STRETCH_LIMITATION;
      ret = true;
    }

#endif
#if NX_SDK_VERSION_NUMBER >= 283
    else if(strcasecmp(str, "NX_SBF_INTER_COLLISION") == 0)
    {
      v = NX_SBF_INTER_COLLISION;
      ret = true;
    }
  ...
  const char * EnumToString(NxSoftBodyAttachmentFlag v)
  {
    ...
    switch(v)
    {
      case NX_SOFTBODY_ATTACHMENT_TWOWAY:
        ret = "NX_SOFTBODY_ATTACHMENT_TWOWAY";
        break;
      case NX_SOFTBODY_ATTACHMENT_TEARABLE:
        ret = "NX_SOFTBODY_ATTACHMENT_TEARABLE";
        break;
      default:
        break;
    }
  ...
  bool         StringToEnum(const char *str, NxSoftBodyAttachmentFlag &v)
  {
    ...
    else if(strcasecmp(str, "NX_SOFTBODY_ATTACHMENT_TWOWAY") == 0)
    {
      v = NX_SOFTBODY_ATTACHMENT_TWOWAY;
      ret = true;
    }
    else if(strcasecmp(str, "NX_SOFTBODY_ATTACHMENT_TEARABLE") == 0)
    {
      v = NX_SOFTBODY_ATTACHMENT_TEARABLE;
      ret = true;
    }
  ...
  const char * EnumToString(NxMeshDataFlags v)
  {
    ...
    switch(v)
    {
      case NX_MDF_16_BIT_INDICES:
        ret = "NX_MDF_16_BIT_INDICES";
        break;
      default:
        break;
    }
  ...
  bool         StringToEnum(const char *str, NxMeshDataFlags &v)
  {
    ...
    else if(strcasecmp(str, "NX_MDF_16_BIT_INDICES") == 0)
    {
      v = NX_MDF_16_BIT_INDICES;
      ret = true;
    }
  ...
  const char * EnumToString(SCHEMA_CLASS v)
  {
    ...
    switch(v)
    {
      case SC_NXUSTREAM2:
        ret = "SC_NXUSTREAM2";
        break;
      case SC_NxCompartmentFlag:
        ret = "SC_NxCompartmentFlag";
        break;
      case SC_NxCompartmentDesc:
        ret = "SC_NxCompartmentDesc";
        break;
      case SC_NxParameterDesc:
        ret = "SC_NxParameterDesc";
        break;
      case SC_NxConvexFlags:
        ret = "SC_NxConvexFlags";
        break;
      case SC_NxConvexMeshDesc:
        ret = "SC_NxConvexMeshDesc";
        break;
      case SC_NxMeshFlags:
        ret = "SC_NxMeshFlags";
        break;
      case SC_NxSimpleTriangleMesh:
        ret = "SC_NxSimpleTriangleMesh";
        break;
      case SC_NxCCDSkeletonDesc:
        ret = "SC_NxCCDSkeletonDesc";
        break;
      case SC_NxTriangleMeshDesc:
        ret = "SC_NxTriangleMeshDesc";
        break;
      case SC_NxHeightFieldFlags:
        ret = "SC_NxHeightFieldFlags";
        break;
      case SC_NxHeightFieldDesc:
        ret = "SC_NxHeightFieldDesc";
        break;
      case SC_NxClothAttachDesc:
        ret = "SC_NxClothAttachDesc";
        break;
      case SC_NxConstraintDominanceDesc:
        ret = "SC_NxConstraintDominanceDesc";
        break;
      case SC_NxClothMeshFlags:
        ret = "SC_NxClothMeshFlags";
        break;
      case SC_NxClothVertexFlags:
        ret = "SC_NxClothVertexFlags";
        break;
      case SC_NxClothMeshDesc:
        ret = "SC_NxClothMeshDesc";
        break;
      case SC_NxGroupsMask:
        ret = "SC_NxGroupsMask";
        break;
      case SC_NxActorGroupPair:
        ret = "SC_NxActorGroupPair";
        break;
      case SC_NxSceneLimits:
        ret = "SC_NxSceneLimits";
        break;
      case SC_NxSceneFlags:
        ret = "SC_NxSceneFlags";
        break;
      case SC_NxMaterialFlag:
        ret = "SC_NxMaterialFlag";
        break;
      case SC_NxSpringDesc:
        ret = "SC_NxSpringDesc";
        break;
      case SC_NxMaterialDesc:
        ret = "SC_NxMaterialDesc";
        break;
      case SC_NxBodyFlag:
        ret = "SC_NxBodyFlag";
        break;
      ...
      case SC_NxActorFlag:
        ret = "SC_NxActorFlag";
        break;
      case SC_NxShapeCompartmentType:
        ret = "SC_NxShapeCompartmentType";
        break;
      case SC_NxShapeFlag:
        ret = "SC_NxShapeFlag";
        break;
      case SC_NxCapsuleShapeFlag:
        ret = "SC_NxCapsuleShapeFlag";
        break;
      case SC_NxTireFunctionDesc:
        ret = "SC_NxTireFunctionDesc";
        break;
      case SC_NxWheelShapeFlags:
        ret = "SC_NxWheelShapeFlags";
        break;
      case SC_NxShapeDesc:
        ret = "SC_NxShapeDesc";
        break;
      case SC_NxBoxShapeDesc:
        ret = "SC_NxBoxShapeDesc";
        break;
      case SC_NxPlaneShapeDesc:
        ret = "SC_NxPlaneShapeDesc";
        break;
      case SC_NxSphereShapeDesc:
        ret = "SC_NxSphereShapeDesc";
        break;
      case SC_NxCapsuleShapeDesc:
        ret = "SC_NxCapsuleShapeDesc";
        break;
      case SC_NxMeshShapeFlag:
        ret = "SC_NxMeshShapeFlag";
        break;
      case SC_NxConvexShapeDesc:
        ret = "SC_NxConvexShapeDesc";
        break;
      case SC_NxTriangleMeshShapeDesc:
        ret = "SC_NxTriangleMeshShapeDesc";
        break;
      case SC_NxWheelShapeDesc:
        ret = "SC_NxWheelShapeDesc";
        break;
      case SC_NxHeightFieldShapeDesc:
        ret = "SC_NxHeightFieldShapeDesc";
        break;
      case SC_NxActorDesc:
        ret = "SC_NxActorDesc";
        break;
      case SC_NxJointFlag:
        ret = "SC_NxJointFlag";
        break;
      case SC_NxPlaneInfoDesc:
        ret = "SC_NxPlaneInfoDesc";
        break;
      case SC_NxJointDesc:
        ret = "SC_NxJointDesc";
        break;
      case SC_NxCylindricalJointDesc:
        ret = "SC_NxCylindricalJointDesc";
        break;
      case SC_NxJointLimitSoftDesc:
        ret = "SC_NxJointLimitSoftDesc";
        break;
      case SC_NxJointLimitSoftPairDesc:
        ret = "SC_NxJointLimitSoftPairDesc";
        break;
      case SC_NxD6JointDriveType:
        ret = "SC_NxD6JointDriveType";
        break;
      case SC_NxJointDriveDesc:
        ret = "SC_NxJointDriveDesc";
        break;
      case SC_NxD6JointFlag:
        ret = "SC_NxD6JointFlag";
        break;
      case SC_NxD6JointDesc:
        ret = "SC_NxD6JointDesc";
        break;
      case SC_NxDistanceJointFlag:
        ret = "SC_NxDistanceJointFlag";
        break;
      case SC_NxDistanceJointDesc:
        ret = "SC_NxDistanceJointDesc";
        break;
      case SC_NxFixedJointDesc:
        ret = "SC_NxFixedJointDesc";
        break;
      case SC_NxPointInPlaneJointDesc:
        ret = "SC_NxPointInPlaneJointDesc";
        break;
      case SC_NxPointOnLineJointDesc:
        ret = "SC_NxPointOnLineJointDesc";
        break;
      case SC_NxPrismaticJointDesc:
        ret = "SC_NxPrismaticJointDesc";
        break;
      case SC_NxJointLimitDesc:
        ret = "SC_NxJointLimitDesc";
        break;
      case SC_NxJointLimitPairDesc:
        ret = "SC_NxJointLimitPairDesc";
        break;
      case SC_NxMotorDesc:
        ret = "SC_NxMotorDesc";
        break;
      case SC_NxRevoluteJointFlag:
        ret = "SC_NxRevoluteJointFlag";
        break;
      case SC_NxRevoluteJointDesc:
        ret = "SC_NxRevoluteJointDesc";
        break;
      case SC_NxSphericalJointFlag:
        ret = "SC_NxSphericalJointFlag";
        break;
      case SC_NxSphericalJointDesc:
        ret = "SC_NxSphericalJointDesc";
        break;
      case SC_NxPulleyJointFlag:
        ret = "SC_NxPulleyJointFlag";
        break;
      case SC_NxPulleyJointDesc:
        ret = "SC_NxPulleyJointDesc";
        break;
      case SC_NxContactPairFlag:
        ret = "SC_NxContactPairFlag";
        break;
      case SC_NxPairFlagDesc:
        ret = "SC_NxPairFlagDesc";
        break;
      case SC_NxCollisionGroupDesc:
        ret = "SC_NxCollisionGroupDesc";
        break;
      case SC_NxParticleData:
        ret = "SC_NxParticleData";
        break;
      case SC_NxFluidSimulationMethod:
        ret = "SC_NxFluidSimulationMethod";
        break;
      case SC_NxFluidCollisionMethod:
        ret = "SC_NxFluidCollisionMethod";
        break;
      case SC_NxFluidFlag:
        ret = "SC_NxFluidFlag";
        break;
      case SC_NxEmitterType:
        ret = "SC_NxEmitterType";
        break;
      case SC_NxEmitterShape:
        ret = "SC_NxEmitterShape";
        break;
      case SC_NxFluidEmitterFlag:
        ret = "SC_NxFluidEmitterFlag";
        break;
      case SC_NxFluidEmitterDesc:
        ret = "SC_NxFluidEmitterDesc";
        break;
      case SC_NxFluidDesc:
        ret = "SC_NxFluidDesc";
        break;
      ...
      case SC_NxClothDesc:
        ret = "SC_NxClothDesc";
        break;
      case SC_NxForceFieldFlags:
        ret = "SC_NxForceFieldFlags";
        break;
      case SC_NxForceFieldShapeDesc:
        ret = "SC_NxForceFieldShapeDesc";
        break;
      case SC_NxBoxForceFieldShapeDesc:
        ret = "SC_NxBoxForceFieldShapeDesc";
        break;
      case SC_NxSphereForceFieldShapeDesc:
        ret = "SC_NxSphereForceFieldShapeDesc";
        break;
      case SC_NxCapsuleForceFieldShapeDesc:
        ret = "SC_NxCapsuleForceFieldShapeDesc";
        break;
      case SC_NxConvexForceFieldShapeDesc:
        ret = "SC_NxConvexForceFieldShapeDesc";
        break;
      case SC_NxForceFieldShapeGroupFlags:
        ret = "SC_NxForceFieldShapeGroupFlags";
        break;
      case SC_NxForceFieldShapeGroupDesc:
        ret = "SC_NxForceFieldShapeGroupDesc";
        break;
      case SC_NxForceFieldLinearKernelDesc:
        ret = "SC_NxForceFieldLinearKernelDesc";
        break;
      case SC_NxForceFieldScaleTableEntry:
        ret = "SC_NxForceFieldScaleTableEntry";
        break;
      case SC_NxForceFieldGroupReference:
        ret = "SC_NxForceFieldGroupReference";
        break;
      case SC_NxForceFieldDesc:
        ret = "SC_NxForceFieldDesc";
        break;
      case SC_NxSpringAndDamperEffectorDesc:
        ret = "SC_NxSpringAndDamperEffectorDesc";
        break;
      case SC_NxSoftBodyMeshFlags:
        ret = "SC_NxSoftBodyMeshFlags";
        break;
      case SC_NxSoftBodyVertexFlags:
        ret = "SC_NxSoftBodyVertexFlags";
        break;
      case SC_NxSoftBodyMeshDesc:
        ret = "SC_NxSoftBodyMeshDesc";
        break;
      case SC_NxSoftBodyFlag:
        ret = "SC_NxSoftBodyFlag";
        break;
      case SC_NxSoftBodyAttachmentFlag:
        ret = "SC_NxSoftBodyAttachmentFlag";
        break;
      case SC_NxSoftBodyAttachDesc:
        ret = "SC_NxSoftBodyAttachDesc";
        break;
      case SC_NxSoftBodyDesc:
        ret = "SC_NxSoftBodyDesc";
        break;
      case SC_NxSceneDesc:
        ret = "SC_NxSceneDesc";
        break;
      case SC_NxSceneInstanceDesc:
        ret = "SC_NxSceneInstanceDesc";
        break;
      case SC_NxMeshDataFlags:
        ret = "SC_NxMeshDataFlags";
        break;
      case SC_NxPhysicsSDKDesc:
        ret = "SC_NxPhysicsSDKDesc";
        break;
      case SC_NxuPhysicsCollection:
        ret = "SC_NxuPhysicsCollection";
        break;
      case SC_NxScene:
        ret = "SC_NxScene";
        break;
  ...
  bool         StringToEnum(const char *str, SCHEMA_CLASS &v)
  {
    ...
    if(str)
    {
      ...
      else if(strcasecmp(str, "SC_NXUSTREAM2") == 0)
      {
        v = SC_NXUSTREAM2;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxCompartmentFlag") == 0)
      {
        v = SC_NxCompartmentFlag;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxCompartmentDesc") == 0)
      {
        v = SC_NxCompartmentDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxParameterDesc") == 0)
      {
        v = SC_NxParameterDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxConvexFlags") == 0)
      {
        v = SC_NxConvexFlags;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxConvexMeshDesc") == 0)
      {
        v = SC_NxConvexMeshDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxMeshFlags") == 0)
      {
        v = SC_NxMeshFlags;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxSimpleTriangleMesh") == 0)
      {
        v = SC_NxSimpleTriangleMesh;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxCCDSkeletonDesc") == 0)
      {
        v = SC_NxCCDSkeletonDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxTriangleMeshDesc") == 0)
      {
        v = SC_NxTriangleMeshDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxHeightFieldFlags") == 0)
      {
        v = SC_NxHeightFieldFlags;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxHeightFieldDesc") == 0)
      {
        v = SC_NxHeightFieldDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxClothAttachDesc") == 0)
      {
        v = SC_NxClothAttachDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxConstraintDominanceDesc") == 0)
      {
        v = SC_NxConstraintDominanceDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxClothMeshFlags") == 0)
      {
        v = SC_NxClothMeshFlags;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxClothVertexFlags") == 0)
      {
        v = SC_NxClothVertexFlags;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxClothMeshDesc") == 0)
      {
        v = SC_NxClothMeshDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxGroupsMask") == 0)
      {
        v = SC_NxGroupsMask;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxActorGroupPair") == 0)
      {
        v = SC_NxActorGroupPair;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxSceneLimits") == 0)
      {
        v = SC_NxSceneLimits;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxSceneFlags") == 0)
      {
        v = SC_NxSceneFlags;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxMaterialFlag") == 0)
      {
        v = SC_NxMaterialFlag;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxSpringDesc") == 0)
      {
        v = SC_NxSpringDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxMaterialDesc") == 0)
      {
        v = SC_NxMaterialDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxBodyFlag") == 0)
      {
        v = SC_NxBodyFlag;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxBodyDesc") == 0)
      {
        v = SC_NxBodyDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxActorFlag") == 0)
      {
        v = SC_NxActorFlag;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxShapeCompartmentType") == 0)
      {
        v = SC_NxShapeCompartmentType;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxShapeFlag") == 0)
      {
        v = SC_NxShapeFlag;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxCapsuleShapeFlag") == 0)
      {
        v = SC_NxCapsuleShapeFlag;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxTireFunctionDesc") == 0)
      {
        v = SC_NxTireFunctionDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxWheelShapeFlags") == 0)
      {
        v = SC_NxWheelShapeFlags;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxShapeDesc") == 0)
      {
        v = SC_NxShapeDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxBoxShapeDesc") == 0)
      {
        v = SC_NxBoxShapeDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxPlaneShapeDesc") == 0)
      {
        v = SC_NxPlaneShapeDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxSphereShapeDesc") == 0)
      {
        v = SC_NxSphereShapeDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxCapsuleShapeDesc") == 0)
      {
        v = SC_NxCapsuleShapeDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxMeshShapeFlag") == 0)
      {
        v = SC_NxMeshShapeFlag;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxConvexShapeDesc") == 0)
      {
        v = SC_NxConvexShapeDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxTriangleMeshShapeDesc") == 0)
      {
        v = SC_NxTriangleMeshShapeDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxWheelShapeDesc") == 0)
      {
        v = SC_NxWheelShapeDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxHeightFieldShapeDesc") == 0)
      {
        v = SC_NxHeightFieldShapeDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxActorDesc") == 0)
      {
        v = SC_NxActorDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxJointFlag") == 0)
      {
        v = SC_NxJointFlag;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxPlaneInfoDesc") == 0)
      {
        v = SC_NxPlaneInfoDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxJointDesc") == 0)
      {
        v = SC_NxJointDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxCylindricalJointDesc") == 0)
      {
        v = SC_NxCylindricalJointDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxJointLimitSoftDesc") == 0)
      {
        v = SC_NxJointLimitSoftDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxJointLimitSoftPairDesc") == 0)
      {
        v = SC_NxJointLimitSoftPairDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxD6JointDriveType") == 0)
      {
        v = SC_NxD6JointDriveType;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxJointDriveDesc") == 0)
      {
        v = SC_NxJointDriveDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxD6JointFlag") == 0)
      {
        v = SC_NxD6JointFlag;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxD6JointDesc") == 0)
      {
        v = SC_NxD6JointDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxDistanceJointFlag") == 0)
      {
        v = SC_NxDistanceJointFlag;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxDistanceJointDesc") == 0)
      {
        v = SC_NxDistanceJointDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxFixedJointDesc") == 0)
      {
        v = SC_NxFixedJointDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxPointInPlaneJointDesc") == 0)
      {
        v = SC_NxPointInPlaneJointDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxPointOnLineJointDesc") == 0)
      {
        v = SC_NxPointOnLineJointDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxPrismaticJointDesc") == 0)
      {
        v = SC_NxPrismaticJointDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxJointLimitDesc") == 0)
      {
        v = SC_NxJointLimitDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxJointLimitPairDesc") == 0)
      {
        v = SC_NxJointLimitPairDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxMotorDesc") == 0)
      {
        v = SC_NxMotorDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxRevoluteJointFlag") == 0)
      {
        v = SC_NxRevoluteJointFlag;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxRevoluteJointDesc") == 0)
      {
        v = SC_NxRevoluteJointDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxSphericalJointFlag") == 0)
      {
        v = SC_NxSphericalJointFlag;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxSphericalJointDesc") == 0)
      {
        v = SC_NxSphericalJointDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxPulleyJointFlag") == 0)
      {
        v = SC_NxPulleyJointFlag;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxPulleyJointDesc") == 0)
      {
        v = SC_NxPulleyJointDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxContactPairFlag") == 0)
      {
        v = SC_NxContactPairFlag;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxPairFlagDesc") == 0)
      {
        v = SC_NxPairFlagDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxCollisionGroupDesc") == 0)
      {
        v = SC_NxCollisionGroupDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxParticleData") == 0)
      {
        v = SC_NxParticleData;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxFluidSimulationMethod") == 0)
      {
        v = SC_NxFluidSimulationMethod;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxFluidCollisionMethod") == 0)
      {
        v = SC_NxFluidCollisionMethod;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxFluidFlag") == 0)
      {
        v = SC_NxFluidFlag;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxEmitterType") == 0)
      {
        v = SC_NxEmitterType;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxEmitterShape") == 0)
      {
        v = SC_NxEmitterShape;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxFluidEmitterFlag") == 0)
      {
        v = SC_NxFluidEmitterFlag;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxFluidEmitterDesc") == 0)
      {
        v = SC_NxFluidEmitterDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxFluidDesc") == 0)
      {
        v = SC_NxFluidDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxClothFlag") == 0)
      {
        v = SC_NxClothFlag;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxClothDesc") == 0)
      {
        v = SC_NxClothDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxForceFieldFlags") == 0)
      {
        v = SC_NxForceFieldFlags;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxForceFieldShapeDesc") == 0)
      {
        v = SC_NxForceFieldShapeDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxBoxForceFieldShapeDesc") == 0)
      {
        v = SC_NxBoxForceFieldShapeDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxSphereForceFieldShapeDesc") == 0)
      {
        v = SC_NxSphereForceFieldShapeDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxCapsuleForceFieldShapeDesc") == 0)
      {
        v = SC_NxCapsuleForceFieldShapeDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxConvexForceFieldShapeDesc") == 0)
      {
        v = SC_NxConvexForceFieldShapeDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxForceFieldShapeGroupFlags") == 0)
      {
        v = SC_NxForceFieldShapeGroupFlags;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxForceFieldShapeGroupDesc") == 0)
      {
        v = SC_NxForceFieldShapeGroupDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxForceFieldLinearKernelDesc") == 0)
      {
        v = SC_NxForceFieldLinearKernelDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxForceFieldScaleTableEntry") == 0)
      {
        v = SC_NxForceFieldScaleTableEntry;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxForceFieldGroupReference") == 0)
      {
        v = SC_NxForceFieldGroupReference;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxForceFieldDesc") == 0)
      {
        v = SC_NxForceFieldDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxSpringAndDamperEffectorDesc") == 0)
      {
        v = SC_NxSpringAndDamperEffectorDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxSoftBodyMeshFlags") == 0)
      {
        v = SC_NxSoftBodyMeshFlags;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxSoftBodyVertexFlags") == 0)
      {
        v = SC_NxSoftBodyVertexFlags;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxSoftBodyMeshDesc") == 0)
      {
        v = SC_NxSoftBodyMeshDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxSoftBodyFlag") == 0)
      {
        v = SC_NxSoftBodyFlag;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxSoftBodyAttachmentFlag") == 0)
      {
        v = SC_NxSoftBodyAttachmentFlag;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxSoftBodyAttachDesc") == 0)
      {
        v = SC_NxSoftBodyAttachDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxSoftBodyDesc") == 0)
      {
        v = SC_NxSoftBodyDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxSceneDesc") == 0)
      {
        v = SC_NxSceneDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxSceneInstanceDesc") == 0)
      {
        v = SC_NxSceneInstanceDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxMeshDataFlags") == 0)
      {
        v = SC_NxMeshDataFlags;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxPhysicsSDKDesc") == 0)
      {
        v = SC_NxPhysicsSDKDesc;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxuPhysicsCollection") == 0)
      {
        v = SC_NxuPhysicsCollection;
        ret = true;
      }
      else if(strcasecmp(str, "SC_NxScene") == 0)
      {
        v = SC_NxScene;
        ret = true;
      }
      else if(strcasecmp(str, "SC_LAST") == 0)
      {
        v = SC_LAST;
        ret = true;
      }
