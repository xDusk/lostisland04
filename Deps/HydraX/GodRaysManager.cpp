...
namespace Hydrax
{
  ...
  Ogre::Vector2 GodRaysManager::_calculateRayPosition(const int& RayNumber)
  {
    ...
    m_x.y *= mNoiseYNormalMultiplier;
    p_x.y *= mNoiseYNormalMultiplier;
    m_y.y *= mNoiseYNormalMultiplier;
    p_y.y *= mNoiseYNormalMultiplier;
  ...
  void GodRaysManager::_createMaterials(const HydraxComponent& HC)
  {
    ...
    Ogre::String GpuProgramsData[2];
    Ogre::String GpuProgramNames[2];
    ...
    GpuProgramNames[0] = _def_GodRays_Shader_VP_Name;
    GpuProgramNames[1] = _def_GodRays_Shader_FP_Name;
    ...
    GpuProgramsData[0] = VertexProgramData;
    GpuProgramsData[1] =  FragmentProgramData;
    GpuProgramNames[0] = _def_GodRaysDepth_Shader_VP_Name;
    GpuProgramNames[1] = _def_GodRaysDepth_Shader_FP_Name;
