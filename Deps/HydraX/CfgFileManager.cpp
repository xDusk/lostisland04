...
namespace Hydrax
{
  ...
  const Ogre::String CfgFileManager::_getComponentsCfgString() const
  {
    ...
    if(Cmp[0].first)
    {
      ...
      Cmpnts += _getCfgString("SunColor",    mHydrax->getSunColor());
      Cmpnts += "\n";
    }
    ...
    if(Cmp[1].first)
    {
      ...
      Cmpnts += _getCfgString("FoamTransparency", mHydrax->getFoamTransparency());
      Cmpnts += "\n";
    }
    ...
    if(Cmp[2].first)
    {
      ...
      Cmpnts += _getCfgString("DepthLimit", mHydrax->getDepthLimit());
      Cmpnts += "\n";
    }
    ...
    if(Cmp[3].first)
    {
      ...
      Cmpnts += _getCfgString("SmoothPower", mHydrax->getSmoothPower());
      Cmpnts += "\n";
    }
    ...
    if(Cmp[4].first)
    {
      ...
      Cmpnts += _getCfgString("CausticsEnd",   mHydrax->getCausticsEnd());
      Cmpnts += "\n";
    }
    ...
    if(Cmp[7].first)
    {
      ...
      Cmpnts += _getCfgString("GodRaysIntersections", mHydrax->getGodRaysManager()->areObjectsIntersectionsEnabled());
      Cmpnts += "\n";
    }
